...
*/ var r =
	...
	function(e, t, n) {
		...
		var I = { injectEventPluginOrder: O, injectEventPluginsByName: _ };
		function U(e, t) {
			var n = e.stateNode;
			if (!n) return null;
			var r = C(n);
		...
		function _e(e) {
			(e.eventPool = []), (e.getPooled = Ee), (e.release = Oe);
		}
		a(we.prototype, {
		...
		function zr(e, t, n, r) {
			...
			switch (t) {
				...
				case "select":
					...
					break;
				case "textarea":
					Or(e, n), (i = Er(e, n)), Rn("invalid", e), Lr(r, "onChange");
					break;
				default:
					i = n;
			}
		...
		function Br(e, t, n, r, o) {
			switch (t) {
				...
				case "select":
					...
					break;
				case "textarea":
					Or(e, n), Rn("invalid", e), Lr(o, "onChange");
			}
		...
		function ci(e) {
			...
			function l(e, t, n, r) {
				return null !== t && t.type === n.type
					...
					: (((r = Oo(n, e.mode, r)).ref = ui(e, t, n)), (r.return = e), r);
			}
			function c(e, t, n, r) {
				return null === t ||
					4 !== t.tag ||
			...
			function f(e, t, n) {
				...
				if ("object" == typeof t && null !== t) {
					switch (t.$$typeof) {
						case ut:
							return (
								((n = Oo(t, e.mode, n)).ref = ui(e, null, t)), (n.return = e), n
							);
						case lt:
				...
				switch (t.tag) {
								...
								? ((l = r.children),
								  ...
								  1073741823 !== n && 1 & t.mode && r.hidden
										? ((t.expirationTime = 1073741823),
										  (t.memoizedProps = r),
										  (e = null))
										: (Ei(e, t, l), (t.memoizedProps = r), (e = t.child)))
								: (e = Ti(e, t)),
							e
						);
					case 6:
					...
					case 4:
						return (
							...
							lo.current || t.memoizedProps !== o
								? (null === e ? (t.child = si(t, null, o, n)) : Ei(e, t, o),
								  (t.memoizedProps = o),
								  (e = t.child))
								: (e = Ti(e, t)),
							e
					...
					case 10:
						return (
							(n = t.pendingProps),
							lo.current || t.memoizedProps !== n
								? (Ei(e, t, n), (t.memoizedProps = n), (e = t.child))
								: (e = Ti(e, t)),
							e
						);
					case 11:
					...
					case 15:
						return (
							...
							t.memoizedProps === n
								? (e = Ti(e, t))
								: (Ei(e, t, n.children), (t.memoizedProps = n), (e = t.child)),
							e
						);
					case 13:
						return (function(e, t, n) {
							...
							return (t.stateNode = u), Vo(t), Ei(e, t, o.children), t.child;
						})(e, t, n);
					case 12:
						e: if (
							((r = t.type),
							...
							switch ((c = ta).tag) {
								case 2:
									if (256 & c.effectTag && null !== E) {
										...
										var C = x.getSnapshotBeforeUpdate(O, _);
				...
				null !== E &&
					...
					"selectionStart" in k
						...
						: window.getSelection &&
						  ...
						  (O = k[he()].length),
						  (P = Math.min(E.start, O)),
						  (E = void 0 === E.end ? P : Math.min(E.end, O)),
						  !T.extend && P > E && ((O = E), (E = P), (P = O)),
						  (O = Hn(k, P)),
						  (_ = Hn(k, E)),
						  O &&
								_ &&
								...
								((x = document.createRange()).setStart(O.node, O.offset),
								T.removeAllRanges(),
								P > E
		...
		function Wa() {
			return !(null === Ca || Ca.timeRemaining() > Na) && (Oa = !0);
		}
		function qa(e) {
			null === ga && p("246"),
	...
	function(e, t, n) {
		...
		var _ = (O.prototype = new E());
		(_.constructor = O), r(_, w.prototype), (_.isPureReactComponent = !0);
		var x = { current: null },
