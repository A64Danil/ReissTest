!(function(e) {
		...
		var c =
				...
				var t = window.history,
					...
					z = function(e) {
						1 === (H += e)
							...
							: 0 === H &&
							  (x(window, "popstate", R), r && x(window, "hashchange", N));
					},
					q = !1,
					W = {
						length: t.length,
			...
			M = function() {
				...
				var F = C(),
					...
					W = function(e) {
						1 === (q += e)
							? O(window, "hashchange", I)
							: 0 === q && x(window, "hashchange", I);
					},
					B = !1,
					V = {
						length: t.length,
						...
						return (
							...
							a.a.createElement(C.Consumer, null, function(t) {
								...
								var u = i.history,
									l =
										"string" == typeof n
											? Object(c.createLocation)(n, null, null, u.location)
											: n,
									s = u.createHref(l);
								return a.a.createElement(
									"a",
					...
					return (
						...
						(r.handlePush = function(e) {
							var t = r.props,
								...
								o = t.context;
							(o.action = "PUSH"),
								(o.location = ue(n, Object(c.createLocation)(e))),
								(o.url = le(o.location));
						}),
	...
	function(e, t, n) {
		...
		function _(e, t) {
			...
			for (var o = 0; o < n.length; o++)
				if (!O.call(t, n[o]) || !x(e[n[o]], t[n[o]])) return !1;
			return !0;
		}
		var C = n(10),
			k = n(22),
	...
	function(e, t, n) {
		...
		Object.defineProperty(t, "__esModule", { value: !0 }),
			(t.ACTION_CHANGE_CURRENT_QUEST_ID = void 0);
		var r = (function() {
				function e(e, t) {
		...
		var h = (function(e) {
			function t() {
				...
				return (
					e.state || (e.state = l.initialState),
					(e.state = {
...
*/ var r =
					...
					return (
						...
						(r.handlePush = function(e) {
							var t = r.props,
								...
								o = t.context;
							(o.action = "PUSH"),
								(o.location = H(n, Object(c.createLocation)(e))),
								(o.url = z(o.location));
						}),
						(r.handleReplace = function(e) {
							var t = r.props,
					...
					r(t, [
						{
							...
							value: function() {
								return o.default.createElement(
									"select",
									null,
									o.default.createElement("option", { value: "" }, "1"),
									o.default.createElement("option", { value: "" }, "2"),
									o.default.createElement("option", { value: "" }, "3"),
									o.default.createElement("option", { value: "" }, "4"),
									o.default.createElement("option", { value: "" }, "5"),
									o.default.createElement("option", { value: "" }, "6"),
									o.default.createElement("option", { value: "" }, "7"),
									o.default.createElement("option", { value: "" }, "8"),
									o.default.createElement("option", { value: "" }, "9"),
									o.default.createElement("option", { value: "" }, "10")
								);
							}
						}
					]),
	...
	function(e, t, n) {
		...
		var p = (function(e) {
			function t(e) {
				...
				return (
					(n.state = { name: "Rest", nameTwo: "One", currentQuestID: 0 }),
				...
				r(t, [
					...
					},
					{
						...
						value: function(e) {
							...
							this.props.currentQuestIDinStore == s.default.length &&
								console.log("Дошли до последнего итема", s.default.length),
								"next" === t &&
								this.props.currentQuestIDinStore < s.default.length - 1
									? (console.log(
											"Уа!! Попали в кнопку некст! Длина массива - " +
												s.default.length
									  ),
									  this.props.changeCurrentQuestID(
											this.props.currentQuestIDinStore + 1
									  ))
									: "prev" === t &&
									  this.props.currentQuestIDinStore > 0 &&
						...
						value: function() {
							return i.default.createElement(
								...
								i.default.createElement(
									...
									})(s.default, this.props.currentQuestIDinStore)
								),
								i.default.createElement(c.default, null),
	...
	function(e, t, n) {
		...
		t.default = (0, u.connect)(
			function(e) {
				return {
					currentQuestIDinStore: e.currentQuestIDinStore,
					testState: e.testState
				};
			},
			function(e) {
				return {
	...
	function(e, t, n) {
		"use strict";
		Object.defineProperty(t, "__esModule", { value: !0 }),
			(t.reducer = t.initialState = void 0);
		var r =
				Object.assign ||
				function(e) {
					for (var t = 1; t < arguments.length; t++) {
	...
	function(e, t, n) {
		...
		var A = { injectEventPluginOrder: O, injectEventPluginsByName: x };
		function U(e, t) {
			var n = e.stateNode;
			if (!n) return null;
			var r = C(n);
		...
		function D(e, t) {
			null !== e && (R = S(R, e)),
				(e = R),
				(R = null),
				e && (j(e, t ? M : I), R && p("95"), d.rethrowCaughtError());
		}
		function L(e, t, n, r) {
				...
				extractEvents: function(e, t, n, r) {
					...
					return (
						...
						(e = Se
							...
							: (function(e, t) {
									if (Ue)
										return "compositionend" === e || (!Te && Ie(e, t))
											? ((e = me()),
											  (ye._root = null),
											  (ye._startText = null),
		...
		"children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style"
			...
			[
				...
				var t = e[0];
				Ct[t] = new _t(t, 1, !1, e[1], null);
			}),
			["contentEditable", "draggable", "spellCheck", "value"].forEach(function(
				e
			) {
				Ct[e] = new _t(e, 2, !1, e.toLowerCase(), null);
			}),
			["autoReverse", "externalResourcesRequired", "preserveAlpha"].forEach(
				function(e) {
					Ct[e] = new _t(e, 2, !1, e, null);
				}
			),
			"allowFullScreen async autoFocus autoPlay controls default defer disabled formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope"
				.split(" ")
				.forEach(function(e) {
					Ct[e] = new _t(e, 3, !1, e.toLowerCase(), null);
				}),
			["checked", "multiple", "muted", "selected"].forEach(function(e) {
				Ct[e] = new _t(e, 3, !0, e.toLowerCase(), null);
			}),
			["capture", "download"].forEach(function(e) {
				Ct[e] = new _t(e, 4, !1, e.toLowerCase(), null);
			}),
			["cols", "rows", "size", "span"].forEach(function(e) {
				Ct[e] = new _t(e, 6, !1, e.toLowerCase(), null);
			}),
			["rowSpan", "start"].forEach(function(e) {
				Ct[e] = new _t(e, 5, !1, e.toLowerCase(), null);
			});
		var kt = /[\-:]([a-z])/g;
		function Tt(e) {
		...
		"accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height"
			...
			.forEach(function(e) {
				...
				Ct[t] = new _t(t, 1, !1, e, null);
			}),
			"xlink:actuate xlink:arcrole xlink:href xlink:role xlink:show xlink:title xlink:type"
				.split(" ")
				.forEach(function(e) {
					var t = e.replace(kt, Tt);
					Ct[t] = new _t(t, 1, !1, e, "http://www.w3.org/1999/xlink");
				}),
			["xml:base", "xml:lang", "xml:space"].forEach(function(e) {
				var t = e.replace(kt, Tt);
				Ct[t] = new _t(t, 1, !1, e, "http://www.w3.org/XML/1998/namespace");
			}),
			(Ct.tabIndex = new _t("tabIndex", 1, !1, "tabindex", null));
		var Ut = {
			change: {
				phasedRegistrationNames: {
					bubbled: "onChange",
		...
		var _n = {
			...
			Cn = _n.isInteractiveTopLevelEventType,
			kn = [];
		function Tn(e) {
			var t = e.targetInst;
			do {
		...
		function zr(e, t, n, r) {
			...
			switch (t) {
				...
				case "select":
					...
					break;
				case "textarea":
					Or(e, n), (i = Er(e, n)), jn("invalid", e), Lr(r, "onChange");
					break;
				default:
					i = n;
			}
		...
		function Br(e, t, n, r, o) {
			switch (t) {
				...
				case "select":
					...
					break;
				case "textarea":
					Or(e, n), jn("invalid", e), Lr(o, "onChange");
			}
		...
		function qi(e, t, n, r, o, i) {
			...
			do {
				switch (e.tag) {
					case 3:
						return (e.effectTag |= 1024), void Ao(e, (r = Hi(e, r, i)), i);
					case 2:
						if (
							((t = r),
							(n = e.stateNode),
							...
							return (e.effectTag |= 1024), void Ao(e, (r = zi(e, t, i)), i);
				}
				e = e.return;
			} while (null !== e);
		}
				...
				for (Ki && !na && p("263"), n = e.return; null !== n; ) {
					switch (n.tag) {
						case 2:
							...
							break;
						case 3:
							Io(n, (e = Hi(n, (e = zo(t, e)), 1)), 1), fa(n, 1), (n = void 0);
							break e;
					}
					n = n.return;
				}
				3 === e.tag && (Io(e, (n = Hi(e, (n = zo(t, e)), 1)), 1), fa(e, 1)),
					(n = void 0);
			}
			return n;
		}
		...
		function Fa() {
			...
			if (xa) throw ((e = _a), (_a = null), (xa = !1), e);
		}
		function Ha(e, t, n) {
			ba && p("245"),
				(ba = !0),
							...
							switch ((c = ta).tag) {
								case 2:
									if (256 & c.effectTag && null !== E) {
										...
										var C = _.getSnapshotBeforeUpdate(O, x);
					...
					"selectionStart" in k
						...
						: window.getSelection &&
						  ...
						  O &&
								...
								((_ = document.createRange()).setStart(O.node, O.offset),
								T.removeAllRanges(),
								P > E
		...
		var L = {
				Children: {
					...
					forEach: function(e, t, n) {
						if (null == e) return e;
						(t = R(null, null, t, n)), null == e || M(e, "", A, t), N(t);
					},
					count: function(e) {
	...
	,
	function(e, t) {
		e.exports = { "app-container": "_2R1gRzms" };
	},
	,
	function(e, t) {
