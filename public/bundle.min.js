!(function(e) {
		...
		var c =
			...
			P = function() {
				...
				var t = window.history,
					...
					z = function(e) {
						1 === (H += e)
							? (E(window, "popstate", R), r && E(window, "hashchange", N))
							: 0 === H &&
							  (O(window, "popstate", R), r && O(window, "hashchange", N));
					},
					q = !1,
					W = {
						length: t.length,
						...
						push: function(e, r) {
							...
							var i = b(e, r, P(), W.location);
							S.confirmTransitionTo(i, "PUSH", c, function(e) {
								if (e) {
									var r = L(i),
										a = i.key,
										l = i.state;
									if (n)
										if ((t.pushState({ key: a, state: l }, null, r), u))
											...
											var c = D.indexOf(W.location.key),
												s = D.slice(0, -1 === c ? 0 : c + 1);
											s.push(i.key),
												(D = s),
						...
						replace: function(e, r) {
							...
							var i = b(e, r, P(), W.location);
							S.confirmTransitionTo(i, "REPLACE", c, function(e) {
								if (e) {
									var r = L(i),
										a = i.key,
										l = i.state;
				...
				var F = C(),
					...
					V = {
						...
						push: function(e, t) {
							...
							var n = b(e, void 0, void 0, V.location);
							k.confirmTransitionTo(n, "PUSH", i, function(e) {
								if (e) {
									...
									if (R() !== r) {
										...
										var i = H.lastIndexOf(m(V.location)),
											a = H.slice(0, -1 === i ? 0 : i + 1);
										a.push(t), (H = a), T({ action: "PUSH", location: n });
									} else
										o()(
											!1,
							...
							k.confirmTransitionTo(n, "REPLACE", i, function(e) {
								if (e) {
									var t = m(n),
										r = y(c + t);
									R() !== r && ((M = t), N(r));
									var o = H.indexOf(m(V.location));
									-1 !== o && (H[o] = t), T({ action: "REPLACE", location: n });
								}
							});
						},
						go: z,
			...
			D = function() {
				var e =
					...
					h = m,
					y = function(e) {
						var n = U(v.index + e, 0, v.entries.length - 1),
							r = v.entries[n];
	...
	function(e, t, n) {
				...
				return (
					...
					(t.prototype.render = function() {
						...
						return (
							...
							a.a.createElement(C.Consumer, null, function(t) {
								var i = t.router;
								f()(i, "You should not use <Link> outside a <Router>");
								var u = i.history,
									l =
										"string" == typeof n
											? Object(c.c)(n, null, null, u.location)
											: n,
									s = u.createHref(l);
								return a.a.createElement(
									"a",
									k({}, o, { onClick: e.handleClick(u), href: s, ref: r })
								);
							})
						);
					}),
		...
		var W = function(e) {
				return a.a.createElement(d.Consumer, null, function(t) {
					var n = t.router;
					return a.a.createElement(q, F({}, e, { router: n }));
				});
			},
			B = W,
			V =
		...
		(Y.propTypes = {
			...
			(Y.defaultProps = { activeClassName: "active", "aria-current": "page" });
		var $ = Y,
			K =
				Object.assign ||
				function(e) {
		...
		var X = function(e) {
				return a.a.createElement(d.Consumer, null, function(t) {
					var n = t.router;
					return a.a.createElement(G, K({}, e, { router: n }));
				});
			},
			J = {},
			Z = 0,
	...
	function(e, t, n) {
		...
		Object.defineProperty(t, "__esModule", { value: !0 }),
			(t.ACTION_CHANGE_QUEST_ANSWER = t.ACTION_CHANGE_CURRENT_QUEST_ID = void 0);
		var r = (function() {
				function e(e, t) {
	...
	function(e, t, n) {
		...
		var C = n(8),
			...
			P = (k.a || T || Function("return this")()).Symbol,
			S = Object.prototype;
		S.hasOwnProperty,
			S.toString,
			P && P.toStringTag,
...
*/ var r =
	...
	function(e, t, n) {
				...
				return (
					...
					(t.prototype.computeTo = function(e) {
						...
						return t
							? "string" == typeof n
								? C(n, t.params)
								: k({}, n, { pathname: C(n.pathname, t.params) })
							: n;
					}),
					(t.prototype.perform = function() {
		...
		(I.propTypes = {
			...
			(I.childContextTypes = { router: l.a.object.isRequired });
		var U = I,
			D =
				Object.assign ||
				function(e) {
		...
		var F = function(e) {
			...
			H = function(e, t) {
				return e ? D({}, t, { pathname: F(e) + t.pathname }) : t;
			},
			z = function(e) {
				return "string" == typeof e ? e : Object(c.e)(e);
			},
			...
			B = (function(e) {
				...
				return (
					...
					(t.prototype.render = function() {
						...
						return a.a.createElement(y, D({}, r, { history: o }));
					}),
					t
				);
			})(a.a.Component);
		(B.propTypes = {
			...
			(B.childContextTypes = { router: l.a.object.isRequired });
		var V = B,
			Q = (function(e) {
				function t() {
					return (
				...
				r(t, [
					{
						...
						value: function() {
							...
							return i.default.createElement(
								"div",
								{
									className: a.default.questWrapper,
									"data-key": "QuestID_" + n,
									key: n + o.default.generate()
								},
								i.default.createElement(
									"div",
									{ className: a.default.questCounter },
									n + 1,
									"/",
									t.length,
									" желание"
								...
								i.default.createElement(
									"h1",
									{ className: a.default.questTitle },
									t[n].title
								),
								i.default.createElement(
									"p",
									{ className: a.default.questDescr },
									t[n].description
								),
								i.default.createElement(
									"div",
									{ className: a.default.descWrapper, "data-descr": r },
									i.default.createElement(
										"div",
										{ className: a.default.ldesc },
										i.default.createElement(
											"div",
											{ className: a.default.descTitle },
											"Низкое"
										),
										t[n].ldesc
									),
		...
		var h = (function(e) {
			function t(e) {
				...
				return (
					...
					(n.changeCurrentQuestID = n.changeCurrentQuestID.bind(n)),
			...
			return (
				...
				r(t, [
					...
					{
						key: "changeCurrentQuestID",
						value: function(e) {
							var t = e.target.dataset.action;
							this.props.userReducer.currentQuestIDinStore ==
								p.default.length &&
								console.log("Дошли до последнего итема", p.default.length),
								"next" === t &&
								this.props.userReducer.currentQuestIDinStore <
									p.default.length - 1
									? (console.log(
											"Уа!! Попали в кнопку некст! Длина массива - " +
												p.default.length
									  ),
					...
					},
					{
						key: "answerAccept",
						value: function(e) {
							var t = "id" + this.props.userReducer.currentQuestIDinStore,
								n = e.currentTarget.value,
								r = void 0;
							n < 150
								? ((r = 100), console.log("Позиция 1"))
								: n < 250
									? ((r = 200), console.log("Позиция 2"))
									: n <= 350
										? ((r = 300), console.log("Позиция 3"))
										: n <= 450
											? ((r = 400), console.log("Позиция 4"))
											: ((r = 500), console.log("Позиция 5")),
								console.log(n),
								this.props.changeQuestAnswer(r, t);
						}
					},
					{
						key: "render",
						value: function() {
							var e = "id" + this.props.userReducer.currentQuestIDinStore,
								t = this.props.answerReducer[e];
							return (
								console.log(t),
								i.default.createElement(
									o.Fragment,
									...
									i.default.createElement(f.default, {
										...
										currentAnswer: this.props.answerReducer[e]
									}),
									i.default.createElement(
										"div",
										{ className: c.default.slidecontainer },
										i.default.createElement(s.default, {
											onChange: this.answerAccept,
											value: this.props.answerReducer[e]
										}),
										i.default.createElement(
											"div",
											{ className: c.default.questAnswer },
											"Текущий ответ: ",
											t
										),
										i.default.createElement(
	...
	function(e, t, n) {
		"use strict";
		Object.defineProperty(t, "__esModule", { value: !0 }),
			(t.changeQuestAnswer = t.changeCurrentQuestID = void 0);
		var r = n(11);
	...
	function(e, t, n) {
		...
		t.default = (0, u.connect)(
			function(e) {
				return { userReducer: e.userReducer, answerReducer: e.answerReducer };
			},
			function(e) {
				return {
					changeCurrentQuestID: (0, a.bindActionCreators)(
						c.changeCurrentQuestID,
						e
					),
					changeQuestAnswer: (0, a.bindActionCreators)(c.changeQuestAnswer, e)
				};
			}
		)(y);
	},
	...
	function(e, t, n) {
		...
		var r =
			...
			o = (n(11), { currentQuestIDinStore: 0, name: "Unnamed" });
 ...
 */ (t.parse = function(
	...
	function(e, t, n) {
		...
		var I = { injectEventPluginOrder: E, injectEventPluginsByName: O };
		function U(e, t) {
			var n = e.stateNode;
			if (!n) return null;
			var r = C(n);
		...
		function G(e) {
			e && e.dispatchConfig.phasedRegistrationNames && $(e._targetInst, K, e);
		}
		function X(e) {
		...
		var Se = i.canUseDOM && "TextEvent" in window && !Pe,
			je = i.canUseDOM && (!Te || (Pe && 8 < Pe && 11 >= Pe)),
			...
			De = {
				...
				extractEvents: function(e, t, n, r) {
					...
					return (
						o
							? (je &&
									(Ue || o !== Ne.compositionStart
										? o === Ne.compositionEnd && Ue && (i = me())
										: ((ye._root = r), (ye._startText = ve()), (Ue = !0))),
						...
						(e = Se
							...
							: (function(e, t) {
									if (Ue)
										return "compositionend" === e || (!Te && Ae(e, t))
											? ((e = me()),
											  (ye._root = null),
											  (ye._startText = null),
		...
		function We(e) {
			He ? (ze ? ze.push(e) : (ze = [e])) : (He = e);
		}
		function Be() {
			return null !== He || null !== ze;
		}
		function Ve() {
			if (He) {
				var e = He,
					t = ze;
				if (((ze = He = null), qe(e), t))
		...
		"children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style"
			...
			[
				...
				var t = e[0];
				Ct[t] = new xt(t, 1, !1, e[1], null);
			}),
			["contentEditable", "draggable", "spellCheck", "value"].forEach(function(
				e
			) {
				Ct[e] = new xt(e, 2, !1, e.toLowerCase(), null);
			}),
			["autoReverse", "externalResourcesRequired", "preserveAlpha"].forEach(
				function(e) {
					Ct[e] = new xt(e, 2, !1, e, null);
				}
			),
			"allowFullScreen async autoFocus autoPlay controls default defer disabled formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope"
				.split(" ")
				.forEach(function(e) {
					Ct[e] = new xt(e, 3, !1, e.toLowerCase(), null);
				}),
			["checked", "multiple", "muted", "selected"].forEach(function(e) {
				Ct[e] = new xt(e, 3, !0, e.toLowerCase(), null);
			}),
			["capture", "download"].forEach(function(e) {
				Ct[e] = new xt(e, 4, !1, e.toLowerCase(), null);
			}),
			["cols", "rows", "size", "span"].forEach(function(e) {
				Ct[e] = new xt(e, 6, !1, e.toLowerCase(), null);
			}),
			["rowSpan", "start"].forEach(function(e) {
				Ct[e] = new xt(e, 5, !1, e.toLowerCase(), null);
			});
		var kt = /[\-:]([a-z])/g;
		function Tt(e) {
		...
		"accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height"
			...
			.forEach(function(e) {
				...
				Ct[t] = new xt(t, 1, !1, e, null);
			}),
			"xlink:actuate xlink:arcrole xlink:href xlink:role xlink:show xlink:title xlink:type"
				.split(" ")
				.forEach(function(e) {
					var t = e.replace(kt, Tt);
					Ct[t] = new xt(t, 1, !1, e, "http://www.w3.org/1999/xlink");
				}),
			["xml:base", "xml:lang", "xml:space"].forEach(function(e) {
				var t = e.replace(kt, Tt);
				Ct[t] = new xt(t, 1, !1, e, "http://www.w3.org/XML/1998/namespace");
			}),
			(Ct.tabIndex = new xt("tabIndex", 1, !1, "tabindex", null));
		var Ut = {
			change: {
				phasedRegistrationNames: {
					bubbled: "onChange",
		...
		var Wt = !1;
		function Bt() {
			Lt && (Lt.detachEvent("onpropertychange", Vt), (Ft = Lt = null));
		}
		function Vt(e) {
			"value" === e.propertyName && zt(Ft) && Xe(Ht, (e = Dt(Ft, e, et(e))));
		}
		function Qt(e, t, n) {
			"focus" === e
				? (Bt(), (Ft = n), (Lt = t).attachEvent("onpropertychange", Vt))
				: "blur" === e && Bt();
		}
		function Yt(e) {
		...
		function $n(e, t) {
			...
			return (
				...
				Qn && c(Qn, n)
					? null
					: ((Qn = n),
					  ((e = we.getPooled(Wn.select, Vn, e, t)).type = "select"),
					  (e.target = Bn),
					  ee(e),
					  e)
			);
			...
			var or =
				...
				hr = function(e, t) {
					...
					try {
						...
						rr(e), r || ((lr = !0), window.postMessage(yr, "*"));
					}
				},
				yr =
					"__reactIdleCallback$" +
		...
		function zr(e, t, n, r) {
			...
			switch (t) {
				...
				case "details":
					...
					break;
				case "input":
					jt(e, n), (i = St(e, n)), jn("invalid", e), Lr(r, "onChange");
					break;
				case "option":
					i = br(e, n);
					break;
				case "select":
					...
					break;
				case "textarea":
					Er(e, n), (i = _r(e, n)), jn("invalid", e), Lr(r, "onChange");
					break;
				default:
					i = n;
			}
		...
		function Br(e, t, n, r, o) {
			switch (t) {
				...
				case "details":
					...
					break;
				case "input":
					jt(e, n), jn("invalid", e), Lr(o, "onChange");
					break;
				case "select":
					wr(e, n), jn("invalid", e), Lr(o, "onChange");
					break;
				case "textarea":
					Er(e, n), jn("invalid", e), Lr(o, "onChange");
			}
		...
		function Vo(e) {
			...
			ao(Bo, t._changedBits),
				ao(Wo, t._currentValue),
				ao(qo, e),
		...
		function ii(e, t) {
			...
			(r.props = o),
				...
				null !== (i = e.updateQueue) &&
					(Lo(e, i, o, r, t), (r.state = e.memoizedState)),
		...
		function ci(e) {
			...
			function l(e, t, n, r) {
				return null !== t && t.type === n.type
					...
					: (((r = Eo(n, e.mode, r)).ref = ui(e, t, n)), (r.return = e), r);
			}
			function c(e, t, n, r) {
				return null === t ||
					4 !== t.tag ||
			...
			function f(e, t, n) {
				...
				if ("object" == typeof t && null !== t) {
					switch (t.$$typeof) {
						case ut:
							return (
								((n = Eo(t, e.mode, n)).ref = ui(e, null, t)), (n.return = e), n
							);
						case lt:
							return ((t = Co(t, e.mode, n)).return = e), t;
					}
					if (ai(t) || bt(t))
						return ((t = Oo(t, e.mode, n, null)).return = e), t;
					li(e, t);
				}
				return null;
			}
			function d(e, t, n, r) {
				...
				if ("object" == typeof n && null !== n) {
					...
					if (ai(n) || bt(n)) return null !== o ? null : s(e, t, n, r, null);
					li(e, n);
				}
				return null;
			}
			function h(e, t, n, r, o) {
				...
				if ("object" == typeof r && null !== r) {
					...
					if (ai(r) || bt(r)) return s(t, (e = e.get(n) || null), r, o, null);
					li(t, r);
				}
				return null;
			}
			function y(o, a, u, l) {
				for (
					var c = null, s = null, p = a, y = (a = 0), m = null;
					null !== p && y < u.length;
					y++
				) {
				...
				for (p = r(o, p); y < u.length; y++)
					(m = h(p, o, y, u[y], l)) &&
						(e && null !== m.alternate && p.delete(null === m.key ? y : m.key),
						(a = i(m, a, y)),
			...
			function m(o, a, u, l) {
				...
				for (
					var s = (c = null), y = a, m = (a = 0), v = null, b = u.next();
					null !== y && !b.done;
					m++, b = u.next()
				) {
					...
					switch (i.$$typeof) {
						case ut:
							e: {
								...
								i.type === ct
									? (((r = Oo(i.props.children, e.mode, u, i.key)).return = e),
									  (e = r))
									: (((u = Eo(i, e.mode, u)).ref = ui(e, r, i)),
									  (u.return = e),
									  (e = u));
							}
							return a(e);
				...
				if ("string" == typeof i || "number" == typeof i)
					return (
						...
						null !== r && 6 === r.tag
							...
							: (n(e, r), ((r = xo(i, e.mode, u)).return = e), (e = r)),
						a(e)
					);
				if (ai(i)) return y(e, r, i, u);
				if (bt(i)) return m(e, r, i, u);
				if ((c && li(e, i), void 0 === i && !l))
					switch (e.tag) {
						case 2:
						case 1:
		...
		function Ei(e, t, n, r) {
			t.child = null === e ? fi(t, null, n, r) : si(t, e.child, n, r);
		}
		function Oi(e, t) {
			var n = t.ref;
				...
				case 5:
					...
					if (null !== e && null != t.stateNode) {
						...
						if (((e = Xo($o.current)), gi(t)))
							...
							zr(e, o, n, r), Kr(o, n) && Pi(t), (t.stateNode = e);
						}
		...
		function Li(e) {
			for (var t = e, n = !1, r = void 0, o = void 0; ; ) {
				...
				if (5 === t.tag || 6 === t.tag) {
					...
					(4 === t.tag ? (r = t.stateNode.containerInfo) : Ii(t),
					null !== t.child)
				) {
		...
		function qi(e, t, n, r, o, i) {
			...
			do {
				switch (e.tag) {
					case 3:
						return (e.effectTag |= 1024), void Io(e, (r = Hi(e, r, i)), i);
					case 2:
						if (
							((t = r),
							(n = e.stateNode),
							...
							return (e.effectTag |= 1024), void Io(e, (r = zi(e, t, i)), i);
				}
				e = e.return;
			} while (null !== e);
		}
		...
		function aa(e) {
			for (;;) {
				...
				if (0 == (512 & e.effectTag)) {
					...
					if (null !== (e = Wi(e))) return (e.effectTag &= 511), e;
					if (
						(null !== n &&
					...
					case 2:
						if (((o = bo(t)), null === e))
							if (null === t.stateNode) {
								...
								c = r.state = d;
								var h = t.updateQueue;
								null !== h && (Lo(t, h, i, r, n), (c = t.memoizedState)),
									l !== i || d !== c || lo.current || So
										? ("function" == typeof s &&
												(ti(t, s, i), (c = t.memoizedState)),
										  (l = So || ri(t, l, i, d, c, a))
												? (u ||
														("function" != typeof r.UNSAFE_componentWillMount &&
															"function" != typeof r.componentWillMount) ||
							...
							(u = t.type),
								...
								null !== (h = t.updateQueue) &&
									(Lo(t, h, l, r, n), (d = t.memoizedState)),
								i !== l || c !== d || lo.current || So
									? ("function" == typeof s &&
											(ti(t, s, l), (d = t.memoizedState)),
									  (s = So || ri(t, i, l, c, d, a))
											? (u ||
					...
					case 4:
						return (
							...
							lo.current || t.memoizedProps !== o
								? (null === e ? (t.child = si(t, null, o, n)) : _i(e, t, o),
								  (t.memoizedProps = o),
								  (e = t.child))
								: (e = Ti(e, t)),
							e
					...
					case 13:
						return (function(e, t, n) {
							var r = t.type._context,
								...
								a = !0;
							if (lo.current) a = !1;
							else if (i === o) return (t.stateNode = 0), Vo(t), Ti(e, t);
							var u = o.value;
							if (((t.memoizedProps = o), null === i)) u = 1073741823;
							else if (i.value === o.value) {
								if (i.children === o.children && a)
									return (t.stateNode = 0), Vo(t), Ti(e, t);
								u = 0;
							} else {
								var l = i.value;
								if (
							...
							return (t.stateNode = u), Vo(t), _i(e, t, o.children), t.child;
						})(e, t, n);
					case 12:
						e: if (
							((r = t.type),
		...
		function la(e, t, n) {
			Ki && p("243"),
				...
				(t === Ji && e === Xi && null !== Gi) ||
					...
					(Ji = t),
					(Zi = -1),
					(Gi = _o((Xi = e).current, null, Ji)),
					(e.pendingCommitExpirationTime = 0));
			var r = !1;
			for (ea = !n || Ji <= Vi; ; ) {
				try {
					if (n) for (; null !== Gi && !qa(); ) Gi = ua(Gi);
					...
					if (null === Gi) (r = !0), Wa(t);
						...
						qi(e, o, n, t, 0, Ji), (Gi = aa(n));
					}
				}
				break;
			}
			if (((Ki = !1), r)) return null;
			if (null === Gi) {
		...
		function ca(e, t) {
			var n;
			e: {
				for (Ki && !na && p("263"), n = e.return; null !== n; ) {
					switch (n.tag) {
						case 2:
							var r = n.stateNode;
							if (
							...
							break;
						case 3:
							Ao(n, (e = Hi(n, (e = zo(t, e)), 1)), 1), fa(n, 1), (n = void 0);
							break e;
					}
					n = n.return;
				}
				3 === e.tag && (Ao(e, (n = Hi(e, (n = zo(t, e)), 1)), 1), fa(e, 1)),
					(n = void 0);
			}
			return n;
		}
		...
		function fa(e, t) {
			for (; null !== e; ) {
				if (
					...
					(Ki && !na && Xi === n) || Aa(n, r), Ra > ja && p("185");
				}
				e = e.return;
			}
		}
		function pa() {
			return (Qi = Xr() - Bi), (Vi = 2 + ((Qi / 10) | 0));
		}
		...
		function Ma(e) {
			...
			var t = Xr() - Bi;
			(ma = e), (va = Jr(Ua, { timeout: 10 * (e - 2) - t }));
		}
		function Aa(e, t) {
			if (null === e.nextScheduledRoot)
				(e.remainingExpirationTime = t),
					null === ya
						? ((ha = ya = e), (e.nextScheduledRoot = e))
						: ((ya = ya.nextScheduledRoot = e).nextScheduledRoot = ha);
			else {
				...
				for (var n = ya, r = ha; null !== r; ) {
					...
					if (0 === o) {
						if (
							...
							ha = ya = r.nextScheduledRoot = null;
							break;
						}
						if (r === ha)
							...
							if (r === ya) {
								((ya = n).nextScheduledRoot = ha), (r.nextScheduledRoot = null);
								break;
							}
		...
		function Fa() {
			...
			if (Oa) throw ((e = xa), (xa = null), (Oa = !1), e);
		}
		function Ha(e, t, n) {
			ba && p("245"),
				(ba = !0),
				n
					? null !== (n = e.finishedWork)
						? za(e, n, t)
						: null !== (n = la(e, t, !0)) &&
						  (qa() ? (e.finishedWork = n) : za(e, n, t))
					: null !== (n = e.finishedWork)
						? za(e, n, t)
						: null !== (n = la(e, t, !1)) && za(e, n, t),
				(ba = !1);
		}
		function za(e, t, n) {
			var r = e.firstBatch;
			...
			for (
				$r = { focusedElem: i, selectionRange: a }, Sn(!1), ta = o;
				null !== ta;
							...
							switch ((c = ta).tag) {
								case 2:
									if (256 & c.effectTag && null !== _) {
										...
										var C = x.getSnapshotBeforeUpdate(E, O);
			...
			for (ta = o; null !== ta; ) {
				...
				try {
					for (; null !== ta; ) {
						...
						switch (14 & k) {
							case 2:
								Di(ta), (ta.effectTag &= -3);
								break;
							case 6:
								Di(ta), (ta.effectTag &= -3), Fi(ta.alternate, ta);
								break;
							case 4:
								Fi(ta.alternate, ta);
								break;
			...
			if (
				...
				(k = P.focusedElem),
				(_ = P.selectionRange),
				T !== k && s(document.documentElement, k))
			) {
				null !== _ &&
					zn(k) &&
					((T = _.start),
					...
					"selectionStart" in k
						...
						: window.getSelection &&
						  ...
						  E &&
								...
								T.removeAllRanges(),
								P > _
									? (T.addRange(x), T.extend(O.node, O.offset))
									: (x.setEnd(O.node, O.offset), T.addRange(x))))),
					(T = []);
				...
				for (
					...
					((P = T[k]).element.scrollLeft = P.left),
						(P.element.scrollTop = P.top);
			}
			for ($r = null, Sn(Yr), Yr = null, n.current = t, ta = o; null !== ta; ) {
				(o = !1), (k = void 0);
				try {
					for (T = r; null !== ta; ) {
						var S = ta.effectTag;
		...
		function qa() {
			return !(null === Ca || Ca.timeRemaining() > Na) && (Ea = !0);
		}
		function Wa(e) {
			null === ga && p("246"),
		...
		Fe.injectFiberControlledHostComponent(Qr),
			...
			(Ja.prototype.commit = function() {
				...
				if (((this._defer && null !== t) || p("251"), this._hasChildren)) {
					...
					(this._defer = !1),
						(function(e, t) {
							ba && p("253"), (ga = e), (wa = t), Ha(e, t, !1), Da(), Fa();
						})(e, n),
						(t = this._next),
						(this._next = null),
