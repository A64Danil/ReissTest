		...
		var c =
			...
			M = function() {
				...
				var F = C(),
					...
					B = function(e) {
						1 === (W += e)
							? k(window, "hashchange", U)
							: 0 === W && E(window, "hashchange", U);
					},
					q = !1,
					V = {
						length: t.length,
							...
							O.confirmTransitionTo(n, "PUSH", i, function(e) {
								if (e) {
									...
									if (j() !== r) {
										...
										var i = z.lastIndexOf(y(V.location)),
		...
		var B = function(e) {
			...
			Y = function(e) {
				var t = e.to,
					...
					d = "object" === (void 0 === t ? "undefined" : $(t)) ? t.pathname : t,
					h = d && d.replace(/([.+*?=^!:${}()[\]|/\\])/g, "\\$1");
...
*/ var r =
	...
	function(e, t, n) {
			...
			q = (function(e) {
				...
				return (
					...
					(t.prototype.render = function() {
						...
						return a.a.createElement(m, L({}, r, { history: o }));
					}),
					t
				);
			})(a.a.Component);
		...
		($.contextTypes = {
			...
			($.propTypes = { children: l.a.node, location: l.a.object });
		var Y = $,
			Q = n(7),
			K = n.n(Q),
			G =
	...
	function(e) {
		e.exports = [
			{
				title: "Как вы считаете принятие?1",
	...
	function(e, t, n) {
		...
		var l = (function(e) {
			function t() {
				...
				return (
					(e.state = { name: "Rest", nameTwo: "One", currentQuestID: 1 }),
					(e.nextQuestID = e.nextQuestID.bind(e)),
					(e.prevQuestID = e.prevQuestID.bind(e)),
								...
								i.default.createElement(
									...
									i.default.createElement(
										...
										(function(e, t) {
											...
											var n = e[t];
											return (
												console.log("А тут будет второй параметр" + t),
												i.default.createElement(
													"div",
													{ "data-key": n.index, key: n.index },
										...
										})(a.default, this.state.currentQuestID)
									),
									i.default.createElement(
										"div",
										{ onClick: this.nextQuestID },
										(function(e) {
		...
		var c = { testState: "initial State" },
			s = (function(e) {
				function t() {
					...
					return (
						e.state || (e.state = c),
						(e.state = { testState: "someValue", path: location.pathname }),
						e
					);
				}
				return (
							...
							value: function() {
								return (
									...
									o.default.createElement(
										"div",
										{
											className: u.default["app-container"],
											"data-some": "helllo"
										},
	...
	function(e, t, n) {
						...
						o
							? (Re &&
									(Ae || o !== Ne.compositionStart
										? o === Ne.compositionEnd && Ae && (i = ye())
										: ((me._root = r), (me._startText = ve()), (Ae = !0))),
		...
		function Hr(e, t, n, r) {
			...
			switch (t) {
				...
				case "select":
					...
					break;
				case "textarea":
					kr(e, n), (i = xr(e, n)), Rn("invalid", e), Dr(r, "onChange");
					break;
				default:
					i = n;
			}
		...
		function qr(e, t, n, r, o) {
			switch (t) {
				...
				case "select":
					...
					break;
				case "textarea":
					kr(e, n), Rn("invalid", e), Dr(o, "onChange");
			}
		...
		function ci(e) {
			...
			function l(e, t, n, r) {
				return null !== t && t.type === n.type
					...
					: (((r = ko(n, e.mode, r)).ref = ui(e, t, n)), (r.return = e), r);
			}
			function c(e, t, n, r) {
				return null === t ||
					4 !== t.tag ||
			...
			function f(e, t, n) {
				...
				if ("object" == typeof t && null !== t) {
					switch (t.$$typeof) {
						case ut:
							return (
								((n = ko(t, e.mode, n)).ref = ui(e, null, t)), (n.return = e), n
							);
						case lt:
			...
			function y(o, a, u, l) {
				...
				for (
					var s = (c = null), m = a, y = (a = 0), v = null, b = u.next();
					null !== m && !b.done;
					y++, b = u.next()
				) {
		...
		function Wi(e, t, n, r, o, i) {
			...
			do {
				switch (e.tag) {
					case 3:
						return (e.effectTag |= 1024), void Io(e, (r = zi(e, r, i)), i);
					case 2:
						if (
							((t = r),
							(n = e.stateNode),
							...
							return (e.effectTag |= 1024), void Io(e, (r = Hi(e, t, i)), i);
				}
				e = e.return;
			} while (null !== e);
		}
				...
				for (Ki && !na && p("263"), n = e.return; null !== n; ) {
					switch (n.tag) {
						case 2:
							...
							break;
						case 3:
							Uo(n, (e = zi(n, (e = Ho(t, e)), 1)), 1), fa(n, 1), (n = void 0);
							break e;
					}
					n = n.return;
				}
				3 === e.tag && (Uo(e, (n = zi(e, (n = Ho(t, e)), 1)), 1), fa(e, 1)),
					(n = void 0);
			}
			return n;
		}
		...
		function fa(e, t) {
			for (; null !== e; ) {
				if (
					...
					(Ki && !na && Xi === n) || Ua(n, r), ja > Ra && p("185");
				}
				e = e.return;
			}
		}
		function pa() {
			return ($i = Xr() - qi), (Vi = 2 + (($i / 10) | 0));
		}
		...
		function Ma(e) {
			...
			var t = Xr() - qi;
			(ya = e), (va = Jr(Aa, { timeout: 10 * (e - 2) - t }));
		}
		function Ua(e, t) {
		...
		function Fa() {
			...
			if (Ea) throw ((e = _a), (_a = null), (Ea = !1), e);
		}
		function za(e, t, n) {
			ba && p("245"),
				(ba = !0),
		...
		function Ha(e, t, n) {
			...
			for (
				Qr = { focusedElem: i, selectionRange: a }, Sn(!1), ta = o;
				null !== ta;
							...
							switch ((c = ta).tag) {
								case 2:
									if (256 & c.effectTag && null !== x) {
										...
										var C = _.getSnapshotBeforeUpdate(k, E);
					...
					"selectionStart" in O
						...
						: window.getSelection &&
						  ...
						  k &&
								...
								T.removeAllRanges(),
								P > x
									? (T.addRange(_), T.extend(E.node, E.offset))
									: (_.setEnd(E.node, E.offset), T.addRange(_))))),
					(T = []);
			...
			for (Qr = null, Sn(Yr), Yr = null, n.current = t, ta = o; null !== ta; ) {
				(o = !1), (O = void 0);
				try {
					for (T = r; null !== ta; ) {
						var S = ta.effectTag;
		...
		function Wa() {
			return !(null === Ca || Ca.timeRemaining() > Na) && (ka = !0);
		}
		function Ba(e) {
			null === ga && p("246"),
		...
		Fe.injectFiberControlledHostComponent($r),
