				...
				var t = window.history,
					...
					z = function(e) {
						1 === (H += e)
							...
							: 0 === H &&
							  (_(window, "popstate", j), r && _(window, "hashchange", N));
					},
					W = !1,
					q = {
						length: t.length,
								...
								if (e) {
									...
									if (n)
										if ((t.pushState({ key: a, state: l }, null, r), u))
											...
											var c = D.indexOf(q.location.key),
	...
	function(e, t, n) {
		...
		var q = function(e) {
				return a.a.createElement(d.Consumer, null, function(t) {
					var n = t.router;
					return a.a.createElement(W, F({}, e, { router: n }));
				});
			},
			B = q,
			V =
	...
	function(e, t, n) {
		...
		function x(e, t) {
			...
			for (var o = 0; o < n.length; o++)
				if (!E.call(t, n[o]) || !_(e[n[o]], t[n[o]])) return !1;
			return !0;
		}
		var C = n(8),
			k = n(22),
...
*/ var r =
	...
	function(e) {
		e.exports = [
			{
				title: "0Как вы считаете принятие?",
			...
			{
				title: "1Вы считаете себя добрым?",
				...
				r(t, [
					...
					},
					{
						...
						value: function(e) {
							...
							this.props.userReducer.currentQuestIDinStore ==
								f.default.length &&
								console.log("Дошли до последнего итема", f.default.length),
								"next" === t &&
								this.props.userReducer.currentQuestIDinStore <
									f.default.length - 1
									? (console.log(
					...
					},
					{
						...
						value: function(e) {
							...
							console.log(t),
								this.props.changeQuestAnswer(e.currentTarget.value, t);
						}
					},
					{
						key: "render",
									...
									i.default.createElement(
										...
										(function(e, t) {
											...
											return i.default.createElement(
												...
												i.default.createElement("h3", null, n.title),
												i.default.createElement("p", null, n.description)
											);
										})(f.default, this.props.userReducer.currentQuestIDinStore)
									),
									i.default.createElement(
										"div",
	...
	function(e, t, n) {
		...
		t.default = function() {
			return r.default.createElement(
				"nav",
				{ className: i.default.menu },
				r.default.createElement(
					"div",
					{ className: i.default["toggle-btn"] },
					"☰"
				),
				r.default.createElement(
					"ul",
					...
					r.default.createElement(
						"li",
						{ className: i.default.menu_link },
						r.default.createElement(
							o.NavLink,
							{
								exact: !0,
								to: "/",
								activeClassName: i.default.menu_link__active
							},
							"Home"
						)
					),
					r.default.createElement(
						...
						r.default.createElement(
							o.NavLink,
							{ to: "/about", activeClassName: i.default.menu_link__active },
							"About"
						)
					),
					r.default.createElement(
						...
						r.default.createElement(
							o.NavLink,
							{ to: "/quests", activeClassName: i.default.menu_link__active },
							"Quests"
						)
					)
				)
	...
	function(e, t, n) {
		...
		n(11);
		var o = { id0: 2, id1: 2, id2: 2, id3: 2, id4: 2 };
			...
			switch (t.type) {
				case "CHANGE_QUEST_ANSWER":
					return r(
						...
						})({}, t.payloadID, parseInt(t.payload))
					);
			}
			return e;
		};
	...
	function(e, t, n) {
		...
		var I = { injectEventPluginOrder: E, injectEventPluginsByName: _ };
		function U(e, t) {
			var n = e.stateNode;
			if (!n) return null;
			var r = C(n);
		...
		function D(e, t) {
			null !== e && (j = S(j, e)),
				(e = j),
				(j = null),
				e && (R(e, t ? M : A), j && p("95"), d.rethrowCaughtError());
		}
		function L(e, t, n, r) {
		...
		function _e(e) {
			(e.eventPool = []), (e.getPooled = Oe), (e.release = Ee);
		}
		a(we.prototype, {
		...
		var Se = i.canUseDOM && "TextEvent" in window && !Pe,
			Re = i.canUseDOM && (!Te || (Pe && 8 < Pe && 11 >= Pe)),
		...
		function $n(e, t) {
			...
			return (
				...
				Qn && c(Qn, n)
					? null
					: ((Qn = n),
					  ((e = we.getPooled(qn.select, Vn, e, t)).type = "select"),
					  (e.target = Bn),
					  ee(e),
					  e)
			);
		...
		function zr(e, t, n, r) {
			...
			switch (t) {
				...
				case "details":
					...
					break;
				case "input":
					Rt(e, n), (i = St(e, n)), Rn("invalid", e), Lr(r, "onChange");
					break;
				case "option":
					i = br(e, n);
					break;
				case "select":
					...
					break;
				case "textarea":
					Er(e, n), (i = Or(e, n)), Rn("invalid", e), Lr(r, "onChange");
					break;
				default:
					i = n;
			}
		...
		function Br(e, t, n, r, o) {
			switch (t) {
				...
				case "details":
					...
					break;
				case "input":
					Rt(e, n), Rn("invalid", e), Lr(o, "onChange");
					break;
				case "select":
					wr(e, n), Rn("invalid", e), Lr(o, "onChange");
					break;
				case "textarea":
					Er(e, n), Rn("invalid", e), Lr(o, "onChange");
			}
		...
		function Io(e, t, n) {
			var r = e.updateQueue;
			null ===
			(r = null === r ? (e.updateQueue = Ro(e.memoizedState)) : Uo(e, r))
				.lastCapturedUpdate
					...
					switch (i.$$typeof) {
						case ut:
							e: {
								...
								i.type === ct
									? (((r = _o(i.props.children, e.mode, u, i.key)).return = e),
									  (e = r))
		...
		function aa(e) {
			for (;;) {
				...
				if (0 == (512 & e.effectTag)) {
					...
					if (null !== (e = qi(e))) return (e.effectTag &= 511), e;
					if (
						(null !== n &&
				...
				switch (t.tag) {
					...
					case 4:
						return (
							...
							lo.current || t.memoizedProps !== o
								? (null === e ? (t.child = si(t, null, o, n)) : Oi(e, t, o),
								  (t.memoizedProps = o),
								  (e = t.child))
								: (e = Ti(e, t)),
							e
					...
					case 13:
						return (function(e, t, n) {
							...
							return (t.stateNode = u), Vo(t), Oi(e, t, o.children), t.child;
						})(e, t, n);
					case 12:
						e: if (
							((r = t.type),
		...
		function Fa() {
			...
			if (_a) throw ((e = xa), (xa = null), (_a = !1), e);
		}
		function Ha(e, t, n) {
			ba && p("245"),
				(ba = !0),
				...
				null !== O &&
					...
					"selectionStart" in k
						...
						: window.getSelection &&
						  ...
						  (E = k[he()].length),
						  (P = Math.min(O.start, E)),
						  (O = void 0 === O.end ? P : Math.min(O.end, E)),
						  !T.extend && P > O && ((E = O), (O = P), (P = E)),
						  (E = Hn(k, P)),
						  (_ = Hn(k, O)),
						  E &&
								_ &&
								...
								T.removeAllRanges(),
								P > O
									? (T.addRange(x), T.extend(_.node, _.offset))
									: (x.setEnd(_.node, _.offset), T.addRange(x))))),
					(T = []);
		...
		var L = {
				Children: {
					...
					forEach: function(e, t, n) {
						if (null == e) return e;
						(t = j(null, null, t, n)), null == e || M(e, "", I, t), N(t);
					},
					count: function(e) {
	...
	,
	function(e, t) {
		e.exports = { "app-container": "_2R1gRzms", test_style: "_2Hv3clpY" };
	},
	,
	function(e, t) {
		e.exports = { main: "_1p1DJHpH" };
	},
	,
	function(e, t) {
		e.exports = { slidecontainer: "FRwBE_1Q", slider: "_3JybGnYR" };
	},
	,
	,
	,
