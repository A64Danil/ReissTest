!(function(e) {
		...
		var s =
			...
			P = function() {
				...
				var t = window.history,
					...
					W = function(e) {
						1 === (V += e)
							? (_(window, "popstate", R), r && _(window, "hashchange", M))
							: 0 === V &&
							  (E(window, "popstate", R), r && E(window, "hashchange", M));
					},
					z = !1,
					H = {
						length: t.length,
						...
						push: function(e, r) {
							...
							var i = b(e, r, P(), H.location);
							S.confirmTransitionTo(i, "PUSH", s, function(e) {
								if (e) {
									var r = I(i),
										a = i.key,
										l = i.state;
									if (n)
										if ((t.pushState({ key: a, state: l }, null, r), u))
											...
											var s = U.indexOf(H.location.key),
												c = U.slice(0, -1 === s ? 0 : s + 1);
											c.push(i.key),
												(U = c),
						...
						replace: function(e, r) {
							...
							var i = b(e, r, P(), H.location);
							S.confirmTransitionTo(i, "REPLACE", s, function(e) {
								if (e) {
									var r = I(i),
										a = i.key,
										l = i.state;
			...
			N = function() {
				...
				var F = x(),
					...
					H = function(e) {
						1 === (z += e)
							? _(window, "hashchange", D)
							: 0 === z && E(window, "hashchange", D);
					},
					q = !1,
					B = {
						length: t.length,
							...
							k.confirmTransitionTo(n, "PUSH", i, function(e) {
								if (e) {
									...
									if (R() !== r) {
										...
										var i = V.lastIndexOf(y(B.location)),
											a = V.slice(0, -1 === i ? 0 : i + 1);
										a.push(t), (V = a), C({ action: "PUSH", location: n });
									} else
										o()(
											!1,
							...
							k.confirmTransitionTo(n, "REPLACE", i, function(e) {
								if (e) {
									var t = y(n),
										r = m(s + t);
									R() !== r && ((N = t), M(r));
									var o = V.indexOf(y(B.location));
									-1 !== o && (V[o] = t), C({ action: "REPLACE", location: n });
								}
							});
						},
						go: W,
			...
			U = function() {
				var e =
					...
					h = y,
					m = function(e) {
						var n = L(v.index + e, 0, v.entries.length - 1),
							r = v.entries[n];
				...
				for (
					...
					if ("string" != typeof f) {
						...
						if (r(d)) {
							...
							if (((p = f.asterisk ? u(d) : s(d)), !t[c].test(p)))
								throw new TypeError(
									'Expected "' +
										f.name +
										'" to match "' +
	...
	function(e, t, n) {
		...
		Object.defineProperty(t, "__esModule", { value: !0 }),
			(t.ACTION_CHANGE_SHOW_QUEST = t.ACTION_CHANGE_QUEST_ANSWER = t.ACTION_CHANGE_CURRENT_QUEST_ID = void 0);
		var r = (function() {
				function e(e, t) {
		...
		(t.ACTION_CHANGE_CURRENT_QUEST_ID = "CHANGE_CURRENT_QUEST_ID"),
			(t.ACTION_CHANGE_QUEST_ANSWER = "CHANGE_QUEST_ANSWER"),
			(t.ACTION_CHANGE_SHOW_QUEST = "CHANGE_SHOW_QUEST");
		var d = (0, u.createStore)(
			l.default,
			window.__REDUX_DEVTOOLS_EXTENSION__ &&
				window.__REDUX_DEVTOOLS_EXTENSION__()
		);
		d.subscribe(function() {
			console.log("Стор изменён", d.getState()),
				console.log("Стор изменён", d.getState().userReducer.name);
		});
		var h = (function(e) {
			function t() {
				!(function(e, t) {
						...
						value: function() {
							return (
								...
								i.default.createElement(
									"div",
									{
										className: f.default["app-container"],
										"data-some": "helllo"
									},
		...
		function d() {
			...
			return function(e) {
				return function() {
					...
					return (
						(u = p.apply(void 0, s)(i.dispatch)), a({}, i, { dispatch: u })
					);
				};
			};
		}
	...
	function(e, t, n) {
			...
			S = (function(e) {
				...
				return (
					...
					(t.prototype.render = function() {
						...
						return (
							f()(void 0 !== n, 'You must specify the "to" property'),
							a.a.createElement(x.Consumer, null, function(t) {
								var i = t.router;
								f()(i, "You should not use <Link> outside a <Router>");
								var u = i.history,
									l =
										"string" == typeof n
											? Object(s.c)(n, null, null, u.location)
											: n,
									c = u.createHref(l);
								return a.a.createElement(
									"a",
									k({}, o, { onClick: e.handleClick(u), href: c, ref: r })
								);
							})
						);
					}),
			...
			z = (function(e) {
				function t() {
					...
					return (
						...
						(r.state = { match: r.computeMatch(r.props) }),
						V(r, n)
					);
				}
				return (
					...
					(t.prototype.getChildContext = function() {
						return {
							router: F({}, this.props.router, {
								route: {
									location:
										this.props.location || this.props.router.route.location,
									match: this.state.match
								}
							})
						};
					...
					(t.prototype.componentWillReceiveProps = function(e) {
						o()(
							...
							this.setState({ match: this.computeMatch(e) });
					}),
		...
		(z.propTypes = {
			...
			(z.childContextTypes = { router: l.a.object.isRequired });
		var H = function(e) {
				return a.a.createElement(d.Consumer, null, function(t) {
					var n = t.router;
					return a.a.createElement(z, F({}, e, { router: n }));
				});
			},
			q = H,
			B =
			...
			K = function(e) {
				var t = e.to,
					...
					d = "object" === (void 0 === t ? "undefined" : Q(t)) ? t.pathname : t,
					h = d && d.replace(/([.+*?=^!:${}()[\]|/\\])/g, "\\$1");
				...
				return (
					...
					(t.prototype.enable = function(e) {
						this.unblock && this.unblock(),
							(this.unblock = this.props.router.history.block(e));
					}),
		...
		var X = function(e) {
				return a.a.createElement(d.Consumer, null, function(t) {
					var n = t.router;
					return a.a.createElement(G, $({}, e, { router: n }));
				});
			},
			J = {},
			Z = 0,
			...
			ne = (function(e) {
				...
				return (
					...
					(t.prototype.componentDidUpdate = function(e) {
						var t = Object(s.c)(e.to),
							n = Object(s.c)(this.props.to);
						Object(s.f)(t, n)
							? o()(
									!1,
					...
					(t.prototype.computeTo = function(e) {
						...
						return t
							? "string" == typeof n
								? ee(n, t.params)
								: te({}, n, { pathname: ee(n.pathname, t.params) })
							: n;
					}),
		...
		var re = function(e) {
				return a.a.createElement(d.Consumer, null, function(t) {
					var n = t.router;
					return a.a.createElement(ne, te({}, e, { router: n }));
				});
			},
			oe =
				Object.assign ||
		...
		var ae = function(e) {
			...
			ue = function(e, t) {
				return e ? oe({}, t, { pathname: ae(e) + t.pathname }) : t;
			},
			le = function(e) {
				...
				function t() {
					...
					return (
						...
						(r.createHref = function(e) {
							return ae(r.props.basename + le(e));
						}),
							...
							o = {
								...
								location: (function(e, t) {
									...
									return 0 !== t.pathname.indexOf(n)
										? t
										: oe({}, t, { pathname: t.pathname.substr(n.length) });
								})(t, Object(s.c)(n)),
								push: this.handlePush,
								replace: this.handleReplace,
								go: se("go"),
								goBack: se("goBack"),
								goForward: se("goForward"),
								listen: this.handleListen,
								block: this.handleBlock
							};
						return a.a.createElement(
							v,
							oe({}, r, { history: o, router: this.getChildContext().router })
						);
					}),
					t
				);
		...
		(fe.propTypes = {
			...
			(fe.defaultProps = { basename: "", location: "/" }),
			(fe.childContextTypes = { router: l.a.object.isRequired });
		var pe = fe,
			de =
				Object.assign ||
				function(e) {
		...
		var me = function(e) {
				return a.a.createElement(d.Consumer, null, function(t) {
					var n = t.router;
					return a.a.createElement(he, de({}, e, { router: n }));
				});
			},
			ye = ee,
			ve = I,
			...
			Oe = function(e) {
				var t = function(t) {
					...
					return a.a.createElement(H, {
						children: function(t) {
							return a.a.createElement(e, we({}, r, t, { ref: n }));
						}
					});
				};
				return (
	...
	function(e, t, n) {
		...
		var x = n(9),
			...
			P = (k.a || C || Function("return this")()).Symbol,
			S = Object.prototype;
		S.hasOwnProperty,
			S.toString,
			P && P.toStringTag,
		...
		R.hasOwnProperty, M.call(Object);
		var L = [
				function(e) {
	...
	function(e, t, n) {
		...
		function r(e, t, n) {
			...
			if ("function" != typeof r)
				throw new Error(
					"@autobind decorator can only be applied to methods not: " + typeof r
				);
			var o = !1;
			return {
				configurable: !0,
...
*/ var r =
						...
						value: function() {
							...
							return o.default.createElement(
								...
								o.default.createElement(i.default, {
									...
									onChange: function(t) {
										return e.setState({ currentQuestAnswer: t });
									},
	...
	function(e, t, n) {
		...
		t.routerActions = { push: i, replace: a, go: u, goBack: l, goForward: s };
	},
	function(e, t, n) {
		"use strict";
		Object.defineProperty(t, "__esModule", { value: !0 });
	...
	function(e, t, n) {
				...
				return (
					...
					(t.prototype.computeTo = function(e) {
						...
						return t
							? "string" == typeof n
								? x(n, t.params)
								: k({}, n, { pathname: x(n.pathname, t.params) })
							: n;
					}),
					(t.prototype.perform = function() {
		...
		var F = function(e) {
			...
			V = function(e, t) {
				return e ? U({}, t, { pathname: F(e) + t.pathname }) : t;
			},
			W = function(e) {
				return "string" == typeof e ? e : Object(s.e)(e);
			},
			...
			q = (function(e) {
				...
				return (
					...
					(t.prototype.render = function() {
						...
						return a.a.createElement(m, U({}, r, { history: o }));
					}),
					t
				);
			})(a.a.Component);
		(q.propTypes = {
			...
			(q.childContextTypes = { router: l.a.object.isRequired });
		var B = q,
			Q = (function(e) {
				function t() {
					return (
			...
			X = function(e) {
				var t = function(t) {
					...
					return a.a.createElement(L, {
						children: function(t) {
							return a.a.createElement(e, G({}, r, t, { ref: n }));
						}
					});
				};
				return (
	...
	function(e) {
		e.exports = [
			{
				title: "Любопытство",
				description: "Желание задавать вопросы, познавать, учиться",
				ldesc:
					"0Мнение других людей вас не волнует. Вы уверены в себе и не нуждаетесь в похвале",
				mdesc: "описание средней части",
				rdesc:
					"Вы хотите, чтобы люди вас ценили. Вы боитесь осуждения окружающих и отверженности"
			},
			{
				title: "Признание",
				description: "Здесь будет описание вопроса один",
				ldesc:
					"1Мнение других людей вас не волнует. Вы уверены в себе и не нуждаетесь в похвале",
				mdesc: "описание средней части",
				rdesc:
					"Вы хотите, чтобы люди вас ценили. Вы боитесь осуждения окружающих и отверженности"
			},
			{
				title: "2Вы считаете себя щедрым?",
				description: "Описание вопроса про щедрость",
				ldesc: "описание левой крайности",
				mdesc: "описание средней части",
				rdesc: "описание правой крайности"
			},
			{
				title: "Вы считаете себя добрым?",
				description: "Здесь будет описание вопроса два",
				ldesc: "описание левой крайности",
				mdesc: "описание средней части",
				rdesc: "описание правой крайности"
			},
			{
				title: "Вы считаете себя щедрым?",
				description: "Описание вопроса про щедрость",
				ldesc: "описание левой крайности",
				mdesc: "описание средней части",
				rdesc: "описание правой крайности"
			...
			return (
				...
				(t.prototype.transition = function(e, t, n) {
					...
					if (r) {
						...
						n
							? ((s = setTimeout(p, n)), this.transitionTimeouts.push(s))
							: u.transitionEnd &&
							  (f = (function(e, t) {
									return (
										h.length
						...
						value: function() {
							...
							var e = this.props,
								...
								f = o.default.createElement(
									"div",
									{
										className: u.default.questWrapper,
										"data-key": "QuestID_" + n,
										key: n + i.default.generate()
									},
									o.default.createElement(
										"div",
										{ className: u.default.questCounter },
										n + 1,
										"/",
										t.length,
										" желание"
									...
									o.default.createElement(
										"h1",
										{ className: u.default.questTitle },
										t[n].title
									),
									o.default.createElement(
										"p",
									...
									o.default.createElement(
										"div",
										{ className: u.default.descWrapper, "data-descr": r },
										o.default.createElement(
											"div",
											{ className: u.default.ldesc },
											o.default.createElement(
												"div",
												{ className: u.default.descTitle },
												"Низкое"
											),
											t[n].ldesc
										),
									...
									o.default.createElement(
										"div",
										{ className: l.default.slidecontainer },
		...
		Object.defineProperty(t, "__esModule", { value: !0 }),
			(t.default = function(e, t) {
				var n = e.maxValue,
					o = e.minValue,
					i = e[t];
				return (0, r.isNumber)(i) ||
					((0, r.isObject)(i) &&
						(0, r.isNumber)(i.min) &&
						(0, r.isNumber)(i.max))
					? (0, r.isNumber)(i) && (i < o || i > n)
						? new Error(
								'"' + t + '" must be in between "minValue" and "maxValue"'
						  )
						: (0, r.isObject)(i) &&
						  (i.min < o || i.min > n || i.max < o || i.max > n)
							? new Error(
									'"' + t + '" must be in between "minValue" and "maxValue"'
							  )
							: void 0
					: new Error('"' + t + '" must be a number or a range object');
			});
		var r = n(11);
		e.exports = t.default;
	},
	function(e, t, n) {
		...
		Object.defineProperty(t, "__esModule", { value: !0 }),
			(t.default = function(e) {
				var t = e.maxValue,
					n = e.minValue;
				return (0, r.isNumber)(n) && (0, r.isNumber)(t)
					? n >= t
						? new Error('"minValue" must be smaller than "maxValue"')
						: void 0
					: new Error('"minValue" and "maxValue" must be a number');
			});
		var r = n(11);
		e.exports = t.default;
	},
				...
				return (
					...
					o(t, [
						...
						},
						{
							...
							value: function(e) {
								...
								return this.isMultiValue() &&
									(0, m.distanceTo)(e, n.min) < (0, m.distanceTo)(e, n.max)
									? "min"
									: "max";
							}
						},
						...
						},
						{
							...
							value: function(e) {
								var t = {
										min: l.getValueFromPosition(
											e.min,
											this.props.minValue,
											this.props.maxValue,
											this.getTrackClientRect()
										),
										max: l.getValueFromPosition(
											e.max,
											this.props.minValue,
											this.props.maxValue,
											this.getTrackClientRect()
						...
						},
						{
							...
							value: function(e) {
								var t =
									l.getValueFromProps(this.props, this.isMultiValue())[e] +
									this.props.step;
							...
							value: function(e, t) {
								if (
									...
									var n = this.props,
										...
										a = i.max,
										u = i.min,
										s = l.getPositionFromEvent(e, this.getTrackClientRect()),
										c = l.getValueFromPosition(
											s,
											o,
											r,
											this.getTrackClientRect()
										),
										f = l.getStepValueFromValue(c, this.props.step),
										p = l.getPositionFromEvent(t, this.getTrackClientRect()),
										d = l.getValueFromPosition(
											p,
											o,
											r,
											this.getTrackClientRect()
										),
										h = l.getStepValueFromValue(d, this.props.step) - f,
										m = { min: u - h, max: a - h };
									this.updateValues(m);
								}
							}
							...
							value: function(e, t) {
								if (!this.props.disabled) {
									var n = this.props,
										...
										u = i.min;
									e.preventDefault();
									var s = l.getValueFromPosition(
											t,
											o,
											r,
											this.getTrackClientRect()
										),
										c = l.getStepValueFromValue(s, this.props.step);
									(!this.props.draggableTrack || c > a || c < u) &&
					...
					r(t, [
						{
							...
							value: function() {
								var e = this.props.action,
									t = this.props.questLength - 1;
								return "next" === e && this.props.curQuest == t
									? (console.log("Вы достигли дна"), null)
									: "next" === e
										? o.default.createElement(
												"button",
												{ onClick: this.props.onClick, "data-action": e },
												"Далее >"
										  )
										: "prev" === e && 0 == this.props.curQuest
											? null
											: "prev" === e
												? o.default.createElement(
														"button",
	...
	function(e, t, n) {
		...
		var p = (function(e) {
			function t(e) {
				...
				return (
					(n.state = { btnDirection: "next", currentQuestID: 0 }),
					(n.answerAccept = n.answerAccept.bind(n)),
					(n.changeQuest = n.changeQuest.bind(n)),
					(n.clickHandler = n.clickHandler.bind(n)),
					n
				);
			}
			return (
					...
					},
					{
						...
						value: function(e) {
							var t = e.target.dataset.action,
								n = this.state.currentQuestID;
							"next" === t
								? (n++,
								  this.setState({ btnDirection: "next", currentQuestID: n }),
								  console.log("Current state: " + n))
								: "prev" === t &&
								  (n--,
								  this.setState({ btnDirection: "prev", currentQuestID: n }),
								  console.log("Current state: " + n));
						}
					},
					{
						...
						value: function(e) {
							...
							console.log(t),
								t < 150
									? ((n = 100), console.log("Позиция 1"))
									: t < 250
										? ((n = 200), console.log("Позиция 2"))
										: t < 350
											? ((n = 300), console.log("Позиция 3"))
											: t <= 450
												? ((n = 400), console.log("Позиция 4"))
												: ((n = 500), console.log("Позиция 5")),
								this.setState({ currentQuestAnswer: n });
						}
					},
					{
						key: "render",
						value: function() {
							return (
								this.props.userReducer.currentQuestIDinStore,
								console.log(this.state),
								i.default.createElement(
									o.Fragment,
									null,
									i.default.createElement("h4", null, "Тест Рейса"),
							...
							value: function() {
								return i.default.createElement(
									...
									i.default.createElement(
										"h3",
										null,
										"Переходи на страницу Quest, выбирай разные варианты ответа и они сохронятся"
									)
								);
							}
						}
	...
	function(e, t, n) {
		"use strict";
		Object.defineProperty(t, "__esModule", { value: !0 }),
			(t.changeShowQuest = t.changeQuestAnswer = t.changeCurrentQuestID = void 0);
		var r = n(8);
		(t.changeCurrentQuestID = function(e) {
			return { type: r.ACTION_CHANGE_CURRENT_QUEST_ID, payload: e };
		}),
			(t.changeQuestAnswer = function(e, t) {
				return { type: r.ACTION_CHANGE_QUEST_ANSWER, payload: e, payloadID: t };
			}),
			(t.changeShowQuest = function(e) {
				return { type: r.ACTION_CHANGE_SHOW_QUEST, payload: e };
			});
	},
	function(e, t, n) {
		"use strict";
		...
		t.default = (0, u.connect)(
			function(e) {
				return {
					userReducer: e.userReducer,
					answerReducer: e.answerReducer,
					animateReducer: e.animateReducer
				};
			},
			function(e) {
				return {
					changeCurrentQuestID: (0, a.bindActionCreators)(
						s.changeCurrentQuestID,
						e
					),
					changeQuestAnswer: (0, a.bindActionCreators)(s.changeQuestAnswer, e),
					changeShowQuest: (0, a.bindActionCreators)(s.changeShowQuest, e)
				};
			}
		)(m);
	},
	function(e, t, n) {
		...
		var s = (function(e) {
			function t(e) {
				...
				return (
					(n.state = { menuIsActive: !1 }), (n.openMenu = n.openMenu.bind(n)), n
				);
			}
			return (
				(function(e, t) {
				...
				r(t, [
					{
						...
						value: function() {
							...
							var e = this.state.menuIsActive;
							this.setState({ menuIsActive: !e }), console.log(e);
						}
					},
					{
						key: "render",
						value: function() {
							return i.default.createElement(
								...
								i.default.createElement(
									"div",
									{
										className: u.default["toggle-btn"],
								...
								i.default.createElement(
									"nav",
									{ id: u.default.menu, "data-open": this.state.menuIsActive },
									i.default.createElement(
										"ul",
										{ className: u.default.meniList },
										i.default.createElement(
											"li",
											{ className: u.default.menu_link },
											i.default.createElement(
												a.NavLink,
												{
													exact: !0,
													to: "/",
													activeClassName: u.default.menu_link__active
												},
												"Home"
											)
										),
	...
	function(e, t, n) {
		...
		var r =
			...
			o = (n(8), { showCurrentQuest: !0 });
		t.animateReducer = function() {
			var e =
					arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : o,
				t = arguments[1];
			switch (t.type) {
				case "CHANGE_SHOW_QUEST":
					return r({}, e, { showCurrentQuest: t.payload });
			}
			return e;
		};
	},
	function(e, t, n) {
		...
		var r =
			...
			o = (n(8), { currentQuestIDinStore: 0, name: "Unnamed" });
		t.userReducer = function() {
			var e =
					arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : o,
				t = arguments[1];
			switch (t.type) {
				case "CHANGE_CURRENT_QUEST_ID":
					return r({}, e, { currentQuestIDinStore: t.payload });
			}
			return e;
		};
	},
 ...
 */ (t.parse = function(
	...
	function(e, t, n) {
		...
		(function(e) {
			...
			var u = "undefined" == typeof document || (e && e.env && !1),
				l = {},
				s = void 0;
			function c() {
			...
			function h(e, t, n) {
				(l[e] = t),
					"object" === (void 0 === t ? "undefined" : r(t)) &&
						(l[e] = JSON.stringify(t)),
					u || (document.cookie = o.default.serialize(e, l[e], n)),
					c() && s.cookie && s.cookie(e, t, n);
			}
			function m(e, t) {
				delete l[e],
					(t =
					...
					c() && s.clearCookie && s.clearCookie(e, t);
			}
			function y(e) {
	...
	function(e, t, n) {
		...
		var a,
			u = o.default.loadAll();
		if (u.userAnswers) {
			var l = JSON.parse(u.userAnswers);
			console.log(l), (a = l);
		} else
			console.log("куки не существуют"),
				(a = { id0: 2, id1: 2, id2: 2, id3: 2, id4: 2 });
		t.answerReducer = function() {
			var e =
			...
			switch (t.type) {
				case "CHANGE_QUEST_ANSWER":
					...
					return (
						...
						o.default.save(
							"userAnswers",
							JSON.stringify(r({}, e, i({}, t.payloadID, parseInt(t.payload)))),
							{ path: "/", expires: n, maxAge: 1e3, secure: !1, httpOnly: !1 }
						),
						console.log(u),
						r({}, e, i({}, t.payloadID, parseInt(t.payload)))
					);
			}
			return e;
		};
	...
	function(e, t, n) {
		...
		t.default = (0, r.combineReducers)({
			answerReducer: o.answerReducer,
			userReducer: i.userReducer,
			animateReducer: a.animateReducer
		});
	},
	function(e, t) {
		e.exports = function(e) {
	...
	function(e, t, n) {
		...
		t.default = function(e, t) {
			...
			var c = void 0,
				...
				h = void 0,
				m = function(e) {
					return u(t.getState()).locationBeforeTransitions || (e ? c : void 0);
				};
			if (((c = m()), s)) {
				var y = function() {
					var t = m(!0);
			...
			return (
				(d = e.listen(v)),
				e.getCurrentLocation && v(e.getCurrentLocation()),
				r({}, e, {
					listen: function(n) {
						var r = m(!0),
							o = !1,
	...
	function(e, t, n) {
		...
		t.default = function() {
			return r.default.createElement(
				...
				r.default.createElement(o.Route, { path: "/", component: a.default })
			);
		};
	},
	function(e, t, n) {
	...
	function(e, t, n) {
		...
		function v(e, t, n) {
			w[e] && p("100", e), (w[e] = t), (O[e] = t.eventTypes[n].dependencies);
		}
		var b = [],
			g = {},
			w = {},
		...
		var A = { injectEventPluginOrder: _, injectEventPluginsByName: E };
		function L(e, t) {
			var n = e.stateNode;
			if (!n) return null;
			var r = x(n);
		...
		function U(e, t) {
			null !== e && (R = S(R, e)),
				(e = R),
				(R = null),
				e && (j(e, t ? N : D), R && p("95"), d.rethrowCaughtError());
		}
		function I(e, t, n, r) {
		...
		function Ee(e) {
			(e.eventPool = []), (e.getPooled = Oe), (e.release = _e);
		}
		a(we.prototype, {
			...
			Ee(we);
		var Te = we.extend({ data: null }),
			xe = we.extend({ data: null }),
			ke = [9, 13, 27, 32],
			Ce = i.canUseDOM && "CompositionEvent" in window,
			Pe = null;
		i.canUseDOM && "documentMode" in document && (Pe = document.documentMode);
		var Se = i.canUseDOM && "TextEvent" in window && !Pe,
			je = i.canUseDOM && (!Ce || (Pe && 8 < Pe && 11 >= Pe)),
			...
			Ue = {
				...
				extractEvents: function(e, t, n, r) {
					...
					return (
						o
							? (je &&
									(Le || o !== Me.compositionStart
										? o === Me.compositionEnd && Le && (i = ye())
										: ((me._root = r), (me._startText = ve()), (Le = !0))),
							  (o = Te.getPooled(o, t, n, r)),
							  i ? (o.data = i) : null !== (i = Ae(n)) && (o.data = i),
							  ee(o),
							  (i = o))
							: (i = null),
						(e = Se
							? (function(e, t) {
									switch (e) {
										case "compositionend":
											return Ae(t);
										case "keypress":
											return 32 !== t.which ? null : ((Ne = !0), Re);
										case "textInput":
											return (e = t.data) === Re && Ne ? null : e;
										default:
											return null;
									}
							  })(e, n)
							: (function(e, t) {
									if (Le)
										return "compositionend" === e || (!Ce && De(e, t))
											? ((e = ye()),
											  (me._root = null),
											  (me._startText = null),
							...
							? (((t = xe.getPooled(Me.beforeInput, t, n, r)).data = e), ee(t))
							: (t = null),
		...
		function qe() {
			return null !== Ve || null !== We;
		}
		function Be() {
			if (Ve) {
				var e = Ve,
					t = We;
				if (((We = Ve = null), ze(e), t))
		...
		var it =
			...
			st = at ? Symbol.for("react.fragment") : 60107,
		...
		"children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style"
			...
			[
				...
				var t = e[0];
				xt[t] = new Tt(t, 1, !1, e[1], null);
			}),
			["contentEditable", "draggable", "spellCheck", "value"].forEach(function(
				e
			) {
				xt[e] = new Tt(e, 2, !1, e.toLowerCase(), null);
			}),
			["autoReverse", "externalResourcesRequired", "preserveAlpha"].forEach(
				function(e) {
					xt[e] = new Tt(e, 2, !1, e, null);
				}
			),
			"allowFullScreen async autoFocus autoPlay controls default defer disabled formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope"
				.split(" ")
				.forEach(function(e) {
					xt[e] = new Tt(e, 3, !1, e.toLowerCase(), null);
				}),
			["checked", "multiple", "muted", "selected"].forEach(function(e) {
				xt[e] = new Tt(e, 3, !0, e.toLowerCase(), null);
			}),
			["capture", "download"].forEach(function(e) {
				xt[e] = new Tt(e, 4, !1, e.toLowerCase(), null);
			}),
			["cols", "rows", "size", "span"].forEach(function(e) {
				xt[e] = new Tt(e, 6, !1, e.toLowerCase(), null);
			}),
			["rowSpan", "start"].forEach(function(e) {
				xt[e] = new Tt(e, 5, !1, e.toLowerCase(), null);
			});
		var kt = /[\-:]([a-z])/g;
		function Ct(e) {
		...
		"accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height"
			...
			.forEach(function(e) {
				...
				xt[t] = new Tt(t, 1, !1, e, null);
			}),
			"xlink:actuate xlink:arcrole xlink:href xlink:role xlink:show xlink:title xlink:type"
				.split(" ")
				.forEach(function(e) {
					var t = e.replace(kt, Ct);
					xt[t] = new Tt(t, 1, !1, e, "http://www.w3.org/1999/xlink");
				}),
			["xml:base", "xml:lang", "xml:space"].forEach(function(e) {
				var t = e.replace(kt, Ct);
				xt[t] = new Tt(t, 1, !1, e, "http://www.w3.org/XML/1998/namespace");
			}),
			(xt.tabIndex = new Tt("tabIndex", 1, !1, "tabindex", null));
		var Lt = {
			change: {
				phasedRegistrationNames: {
					bubbled: "onChange",
		...
		var Ht = !1;
		function qt() {
			It && (It.detachEvent("onpropertychange", Bt), (Ft = It = null));
		}
		function Bt(e) {
			"value" === e.propertyName && Wt(Ft) && Xe(Vt, (e = Ut(Ft, e, et(e))));
		}
		function Qt(e, t, n) {
			"focus" === e
				? (qt(), (Ft = n), (It = t).attachEvent("onpropertychange", Bt))
				: "blur" === e && qt();
		}
		function Kt(e) {
		...
		var sn = we.extend({
			...
			fn = Xt.extend({ relatedTarget: null });
		function pn(e) {
			var t = e.keyCode;
			return (
				"charCode" in e
		...
		function Yn(e, t) {
			...
			return (
				...
				Qn && s(Qn, n)
					? null
					: ((Qn = n),
					  ((e = we.getPooled(Hn.select, Bn, e, t)).type = "select"),
					  (e.target = qn),
					  ee(e),
					  e)
			);
		...
		A.injectEventPluginOrder(
			...
			(x = Q.getFiberCurrentPropsFromNode),
			(k = Q.getInstanceFromNode),
			...
			var or =
				...
				hr = function(e, t) {
					...
					try {
						...
						rr(e), r || ((lr = !0), window.postMessage(mr, "*"));
					}
				},
				mr =
					"__reactIdleCallback$" +
			...
			window.addEventListener(
				...
				function(e) {
					if (
						...
						for (e = er(); 0 < cr - e && null !== ir; )
							(e = ir), (dr.didTimeout = !1), hr(e, dr), (e = er());
						null === ir || sr || ((sr = !0), or(yr));
					}
				},
				!1
			);
		...
		function Wr(e, t, n, r) {
			...
			switch (t) {
				...
				case "details":
					...
					break;
				case "input":
					jt(e, n), (i = St(e, n)), jn("invalid", e), Ir(r, "onChange");
					break;
				case "option":
					i = br(e, n);
					break;
				case "select":
					...
					break;
				case "textarea":
					_r(e, n), (i = Or(e, n)), jn("invalid", e), Ir(r, "onChange");
					break;
				default:
					i = n;
			}
				...
				if (s.hasOwnProperty(l)) {
					...
					"style" === l
						...
						: "dangerouslySetInnerHTML" === l
							? null != (c = c ? c.__html : void 0) && Sr(e, c)
							: "children" === l
								? "string" == typeof c
									? ("textarea" !== t || "" !== c) && jr(e, c)
				...
				case "select":
					(e._wrapperState.initialValue = void 0),
						...
						null != (n = o.value)
							...
							: t !== !!o.multiple &&
							  (null != o.defaultValue
									? gr(e, !!o.multiple, o.defaultValue, !0)
									: gr(e, !!o.multiple, o.multiple ? [] : "", !1));
			}
		}
		function qr(e, t, n, r, o) {
			switch (t) {
				...
				case "details":
					...
					break;
				case "input":
					jt(e, n), jn("invalid", e), Ir(o, "onChange");
					break;
				case "select":
					wr(e, n), jn("invalid", e), Ir(o, "onChange");
					break;
				case "textarea":
					_r(e, n), jn("invalid", e), Ir(o, "onChange");
			}
			for (var i in (Ar(t, n, Ur), (r = null), n))
		...
		function yo(e, t, n) {
			uo.current !== f && p("168"), ao(uo, t), ao(lo, n);
		}
		function vo(e, t) {
			var n = e.stateNode,
		...
		function _o(e, t, n) {
			...
			return ((t = new wo(i, e, o, t)).type = r), (t.expirationTime = n), t;
		}
		function Eo(e, t, n, r) {
		...
		function Do(e, t, n) {
			...
			null === i || o === i
				...
				: null === o.lastUpdate || null === i.lastUpdate
					? (No(o, t, n), No(i, t, n))
					: (No(o, t, n), (i.lastUpdate = t));
		}
		function Ao(e, t, n) {
			var r = e.updateQueue;
			null ===
			(r = null === r ? (e.updateQueue = jo(e.memoizedState)) : Lo(e, r))
				.lastCapturedUpdate
		...
		function Io(e, t, n, r, o) {
			if (((So = !1), !(0 === t.expirationTime || t.expirationTime > o))) {
				for (
		...
		function Vo(e, t, n) {
			...
			for (
				...
				null !== (t = e.callback) && ((e.callback = null), Fo(t, n)),
					(e = e.nextEffect);
		}
		function Wo(e, t) {
		...
		function Bo(e) {
			...
			ao(qo, t._changedBits),
				ao(Ho, t._currentValue),
				ao(zo, e),
		...
		function ii(e, t) {
			...
			(r.props = o),
				...
				"function" == typeof (i = e.type.getDerivedStateFromProps) &&
					(ti(e, i, o), (r.state = e.memoizedState)),
				"function" == typeof n.getDerivedStateFromProps ||
					...
					n !== r.state && ni.enqueueReplaceState(r, r.state, null),
					null !== (i = e.updateQueue) &&
						(Io(e, i, o, r, t), (r.state = e.memoizedState))),
		...
		function si(e) {
			...
			function l(e, t, n, r) {
				return null !== t && t.type === n.type
					...
					: (((r = _o(n, e.mode, r)).ref = ui(e, t, n)), (r.return = e), r);
			}
			function s(e, t, n, r) {
				return null === t ||
					4 !== t.tag ||
			...
			function f(e, t, n) {
				...
				if ("object" == typeof t && null !== t) {
					switch (t.$$typeof) {
						case ut:
							return (
								((n = _o(t, e.mode, n)).ref = ui(e, null, t)), (n.return = e), n
							);
						case lt:
			...
			function d(e, t, n, r) {
				...
				if ("object" == typeof n && null !== n) {
					...
					if (ai(n) || bt(n)) return null !== o ? null : c(e, t, n, r, null);
					li(e, n);
				}
				return null;
			}
			function h(e, t, n, r, o) {
				...
				if ("object" == typeof r && null !== r) {
					...
					if (ai(r) || bt(r)) return c(t, (e = e.get(n) || null), r, o, null);
					li(t, r);
				}
				return null;
			}
			function m(o, a, u, l) {
				for (
					var s = null, c = null, p = a, m = (a = 0), y = null;
					null !== p && m < u.length;
					m++
				) {
			...
			function y(o, a, u, l) {
				...
				for (
					var c = (s = null), m = a, y = (a = 0), v = null, b = u.next();
					null !== m && !b.done;
					y++, b = u.next()
				) {
					m.index > y ? ((v = m), (m = null)) : (v = m.sibling);
					var g = d(o, m, b.value, l);
					if (null === g) {
						m || (m = v);
						break;
					}
			...
			return function(e, r, i, u) {
				var l =
					"object" == typeof i && null !== i && i.type === st && null === i.key;
						...
						case ut:
							e: {
								for (s = i.key, l = r; null !== l; ) {
									if (l.key === s) {
										if (10 === l.tag ? i.type === st : l.type === i.type) {
											n(e, l.sibling),
												((r = o(
													l,
				...
				if (bt(i)) return y(e, r, i, u);
				if ((s && li(e, i), void 0 === i && !l))
					switch (e.tag) {
						case 2:
						case 1:
		...
		function gi(e) {
			...
			if (
				...
				for (t = di; t; ) mi(e, t), (t = eo(t));
			return bi(e), (di = pi ? eo(e.stateNode) : null), !0;
		}
		function wi() {
			(di = pi = null), (hi = !1);
		}
			...
			switch (t.tag) {
				...
				case 3:
					...
					return (
						...
						(null !== e && null !== e.child) || (gi(t), (t.effectTag &= -3)),
						Si(t),
						null
					);
				case 5:
					ei(t), (r = Xo(Go.current));
					var o = t.type;
					if (null !== e && null != t.stateNode) {
						...
						if (((e = Xo(Yo.current)), gi(t)))
							...
							Wr(e, o, n, r), $r(o, n) && Pi(t), (t.stateNode = e);
						}
		...
		function zi(e, t, n, r, o, i) {
			...
			do {
				switch (e.tag) {
					case 3:
						return (e.effectTag |= 1024), void Ao(e, (r = Vi(e, r, i)), i);
					case 2:
						if (
							((t = r),
							(n = e.stateNode),
							...
							return (e.effectTag |= 1024), void Ao(e, (r = Wi(e, t, i)), i);
				}
				e = e.return;
			} while (null !== e);
		}
		...
		function ia() {
			...
			(Xi = null), (Ji = 0), (Zi = -1), (ea = !1), (Gi = null), (ra = !1);
		}
		function aa(e) {
			for (;;) {
				var t = e.alternate,
		...
		function ua(e) {
				...
				switch (t.tag) {
					...
					case 2:
						if (((o = bo(t)), null === e))
							if (null === t.stateNode) {
								...
								s = r.state = d;
								var h = t.updateQueue;
								null !== h && (Io(t, h, i, r, n), (s = t.memoizedState)),
									l !== i || d !== s || lo.current || So
										? ("function" == typeof c &&
												(ti(t, c, i), (s = t.memoizedState)),
										  (l = So || ri(t, l, i, d, s, a))
												? (u ||
														("function" != typeof r.UNSAFE_componentWillMount &&
															"function" != typeof r.componentWillMount) ||
							...
							(u = t.type),
								...
								i !== l || s !== d || lo.current || So
									? ("function" == typeof c &&
											(ti(t, c, l), (d = t.memoizedState)),
									  (c = So || ri(t, i, l, s, d, a))
											? (u ||
								  ...
								  (o = t.memoizedState.element) === r
										...
										: ((r = t.stateNode),
										  (r = (null === e || null === e.child) && r.hydrate) &&
												((di = to(t.stateNode.containerInfo)),
												(pi = t),
												(r = hi = !0)),
										  r
												? ((t.effectTag |= 2), (t.child = fi(t, null, o, n)))
												: (wi(), Oi(e, t, o)),
										  (e = t.child)))
								: (wi(), (e = Ci(e, t))),
							e
					...
					case 5:
						return (
							...
							l && 1073741823 === n)
								? ((l = r.children),
								  Gr(o, r) ? (l = null) : i && Gr(o, i) && (t.effectTag |= 16),
								  Ei(e, t),
								  1073741823 !== n && 1 & t.mode && r.hidden
										? ((t.expirationTime = 1073741823),
										  (t.memoizedProps = r),
										  (e = null))
										: (Oi(e, t, l), (t.memoizedProps = r), (e = t.child)))
								: (e = Ci(e, t)),
							e
						);
					case 6:
						return (
							null === e && vi(t), (t.memoizedProps = t.pendingProps), null
						);
					case 16:
						return null;
					case 4:
						return (
							...
							lo.current || t.memoizedProps !== o
								? (null === e ? (t.child = ci(t, null, o, n)) : Oi(e, t, o),
								  (t.memoizedProps = o),
								  (e = t.child))
								: (e = Ci(e, t)),
							e
					...
					case 10:
						return (
							(n = t.pendingProps),
							lo.current || t.memoizedProps !== n
								? (Oi(e, t, n), (t.memoizedProps = n), (e = t.child))
								: (e = Ci(e, t)),
							e
						);
					case 11:
					...
					case 15:
						return (
							...
							t.memoizedProps === n
								? (e = Ci(e, t))
								: (Oi(e, t, n.children), (t.memoizedProps = n), (e = t.child)),
							e
						);
					case 13:
						return (function(e, t, n) {
							var r = t.type._context,
								...
								a = !0;
							if (lo.current) a = !1;
							else if (i === o) return (t.stateNode = 0), Bo(t), Ci(e, t);
							var u = o.value;
							if (((t.memoizedProps = o), null === i)) u = 1073741823;
							else if (i.value === o.value) {
								if (i.children === o.children && a)
									return (t.stateNode = 0), Bo(t), Ci(e, t);
								u = 0;
							} else {
								var l = i.value;
								if (
							...
							return (t.stateNode = u), Bo(t), Oi(e, t, o.children), t.child;
						})(e, t, n);
					case 12:
						e: if (
							((r = t.type),
			...
			return null === t && (t = aa(e)), (it.current = null), t;
		}
		function la(e, t, n) {
			$i && p("243"),
				($i = !0),
				(t === Ji && e === Xi && null !== Gi) ||
					...
					(Ji = t),
					(Zi = -1),
					(Gi = Oo((Xi = e).current, null, Ji)),
					(e.pendingCommitExpirationTime = 0));
			var r = !1;
			for (ea = !n || Ji <= Bi; ; ) {
				try {
					if (n) for (; null !== Gi && !za(); ) Gi = ua(Gi);
					else for (; null !== Gi; ) Gi = ua(Gi);
				} catch (t) {
					if (null === Gi) (r = !0), Ha(t);
					else {
						null === Gi && p("271");
			...
			if (null === Gi) {
				if (ra) return (e.pendingCommitExpirationTime = t), e.current.alternate;
				ea && p("262"),
					0 <= Zi &&
						setTimeout(function() {
					...
					(function(e) {
						null === ga && p("246"), (ga.remainingExpirationTime = e);
		...
		function sa(e, t) {
			var n;
			e: {
				for ($i && !na && p("263"), n = e.return; null !== n; ) {
					switch (n.tag) {
						case 2:
							var r = n.stateNode;
							if (
							...
							break;
						case 3:
							Do(n, (e = Vi(n, (e = Wo(t, e)), 1)), 1), fa(n, 1), (n = void 0);
							break e;
					}
					n = n.return;
				}
				3 === e.tag && (Do(e, (n = Vi(e, (n = Wo(t, e)), 1)), 1), fa(e, 1)),
					(n = void 0);
			}
			return n;
		}
		...
		function fa(e, t) {
			for (; null !== e; ) {
				if (
					...
					($i && !na && Xi === n) || Da(n, r), Ra > ja && p("185");
				}
				e = e.return;
			}
		}
		function pa() {
			return (Qi = Xr() - qi), (Bi = 2 + ((Qi / 10) | 0));
		}
		...
		function Na(e) {
			...
			var t = Xr() - qi;
			(ya = e), (va = Jr(La, { timeout: 10 * (e - 2) - t }));
		}
		function Da(e, t) {
			if (null === e.nextScheduledRoot)
				(e.remainingExpirationTime = t),
					null === ma
						? ((ha = ma = e), (e.nextScheduledRoot = e))
						: ((ma = ma.nextScheduledRoot = e).nextScheduledRoot = ha);
			else {
				...
				for (var n = ma, r = ha; null !== r; ) {
					...
					if (0 === o) {
						if (
							...
							ha = ma = r.nextScheduledRoot = null;
							break;
						}
						if (r === ha)
							(ha = o = r.nextScheduledRoot),
								(ma.nextScheduledRoot = o),
								(r.nextScheduledRoot = null);
						else {
							if (r === ma) {
								((ma = n).nextScheduledRoot = ha), (r.nextScheduledRoot = null);
								break;
							}
		...
		function Ia(e, t, n) {
			if (((xa = n), Aa(), t))
				...
				for (; null !== ga && 0 !== wa && (0 === e || e >= wa); )
					Va(ga, wa, !1), Aa();
			null !== xa && ((ya = 0), (va = null)),
				0 !== wa && Na(wa),
				(xa = null),
				(_a = !1),
				Fa();
		...
		function Fa() {
			...
			if (Ea) throw ((e = Ta), (Ta = null), (Ea = !1), e);
		}
		function Va(e, t, n) {
			ba && p("245"),
				(ba = !0),
		...
		function Wa(e, t, n) {
			...
			if (
				null !== r &&
				r._expirationTime <= n &&
				(null === Sa ? (Sa = [r]) : Sa.push(r), r._defer)
			)
			...
			for (
				Yr = { focusedElem: i, selectionRange: a }, Sn(!1), ta = o;
				null !== ta;
			...
			for (ta = o; null !== ta; ) {
				...
				try {
					for (; null !== ta; ) {
						...
						switch (14 & k) {
							case 2:
								Ui(ta), (ta.effectTag &= -3);
								break;
							case 6:
								Ui(ta), (ta.effectTag &= -3), Fi(ta.alternate, ta);
								break;
							case 4:
								Fi(ta.alternate, ta);
								break;
			...
			if (
				...
				(k = P.focusedElem),
				(O = P.selectionRange),
				C !== k && c(document.documentElement, k))
			) {
				null !== O &&
					Wn(k) &&
					((C = O.start),
					...
					"selectionStart" in k
						...
						: window.getSelection &&
						  ...
						  (_ = k[he()].length),
						  (P = Math.min(O.start, _)),
						  (O = void 0 === O.end ? P : Math.min(O.end, _)),
						  !C.extend && P > O && ((_ = O), (O = P), (P = _)),
						  (_ = Vn(k, P)),
						  (E = Vn(k, O)),
						  _ &&
								E &&
								...
								((T = document.createRange()).setStart(_.node, _.offset),
								C.removeAllRanges(),
								P > O
									? (C.addRange(T), C.extend(E.node, E.offset))
									: (T.setEnd(E.node, E.offset), C.addRange(T))))),
					(C = []);
				...
				for (
					...
					((P = C[k]).element.scrollLeft = P.left),
						(P.element.scrollTop = P.top);
			}
			for (Yr = null, Sn(Kr), Kr = null, n.current = t, ta = o; null !== ta; ) {
				(o = !1), (k = void 0);
				try {
					for (C = r; null !== ta; ) {
						var S = ta.effectTag;
			...
			($i = na = !1),
				...
				0 === (t = n.current.expirationTime) && (oa = null),
				(e.remainingExpirationTime = t);
		}
		function za() {
			return !(null === xa || xa.timeRemaining() > Ma) && (_a = !0);
		}
		function Ha(e) {
			null === ga && p("246"),
				(ga.remainingExpirationTime = 0),
				Ea || ((Ea = !0), (Ta = e));
		}
		function qa(e, t) {
			var n = ka;
		...
		Fe.injectFiberControlledHostComponent(Qr),
			...
			(Ja.prototype.commit = function() {
				...
				if (((this._defer && null !== t) || p("251"), this._hasChildren)) {
					...
					(this._defer = !1),
						(function(e, t) {
							ba && p("253"), (ga = e), (wa = t), Va(e, t, !1), Ua(), Fa();
						})(e, n),
						(t = this._next),
						(this._next = null),
			...
			(eu.prototype.render = function(e, t) {
		...
		var ou = {
			...
			unstable_createRoot: function(e, t) {
				return new eu(e, !0, null != t && !0 === t.hydrate);
			}
		};
		!(function(e) {
		...
		var I = {
				Children: {
					...
					forEach: function(e, t, n) {
						if (null == e) return e;
						(t = R(null, null, t, n)), null == e || N(e, "", A, t), M(t);
					},
					count: function(e) {
	...
	,
	function(e, t) {
		e.exports = { "app-container": "_1q1lWEZz", test_style: "zZRjDsq0" };
	},
	,
	function(e, t) {
		e.exports = { main: "gN3r0idC" };
	},
	,
	function(e, t) {
		e.exports = {
			questWrapper: "_1wuKPg6Y",
			questTitle: "_1kh4LQY5",
			questCounter: "_1Q7IV61O",
			questDescr: "_2AvYY2Zk",
			descWrapper: "_32BSh2HQ",
			descTitle: "_3cmhckk6",
			ldesc: "_2c0hjB9U",
			mdesc: "Lknb-TVk",
			rdesc: "_3HS5LF6k"
	...
	function(e, t) {
		e.exports = {
			slidecontainer: "_1XLQfVOs",
			slider: "_3cExzkXI",
			questAnswer: "_1CVmaVmL"
		};
	},
	,
	function(e, t) {
		e.exports = { buttonWrapper: "_1N15PxYE" };
	},
	,
	,
	,
	...
	function(e, t) {
		e.exports = {
			menu: "_2D0GgjZ9",
			meniList: "_1IzjXvDh",
			"toggle-btn": "_1fzppp4_",
			menu_link: "_3L7oiDGJ",
			menu_link__active: "_3UxazPqR"
		};
	}
]);
