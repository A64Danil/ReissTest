		...
		var c =
				...
				var t = window.history,
					...
					H = function(e) {
						1 === (z += e)
							...
							: 0 === z &&
							  (k(window, "popstate", j), r && k(window, "hashchange", N));
					},
					W = !1,
					B = {
						length: t.length,
			...
			M = function() {
				...
				var F = C(),
					...
					B = function(e) {
						1 === (W += e)
							? E(window, "hashchange", I)
							: 0 === W && k(window, "hashchange", I);
					},
					q = !1,
					V = {
						length: t.length,
							...
							O.confirmTransitionTo(n, "PUSH", i, function(e) {
								if (e) {
									...
									if (j() !== r) {
										...
										var i = z.lastIndexOf(m(V.location)),
											a = z.slice(0, -1 === i ? 0 : i + 1);
										a.push(t), (z = a), T({ action: "PUSH", location: n });
									} else
										o()(
											!1,
					...
					(t.prototype.render = function() {
						...
						return (
							...
							a.a.createElement(C.Consumer, null, function(t) {
								...
								return a.a.createElement(
									"a",
									O({}, o, { onClick: e.handleClick(u), href: s, ref: r })
								);
							})
						);
					}),
...
*/ var r =
	...
	function(e, t, n) {
				...
				return (
					...
					(t.prototype.computeTo = function(e) {
						...
						return t
							? "string" == typeof n
								? C(n, t.params)
								: O({}, n, { pathname: C(n.pathname, t.params) })
							: n;
					}),
					(t.prototype.perform = function() {
		...
		(U.propTypes = {
			...
			(U.childContextTypes = { router: l.a.object.isRequired });
		var A = U,
			L =
				Object.assign ||
				function(e) {
		...
		var F = function(e) {
			...
			z = function(e, t) {
				return e ? L({}, t, { pathname: F(e) + t.pathname }) : t;
			},
			H = function(e) {
				return "string" == typeof e ? e : Object(c.createPath)(e);
			},
			...
			q = (function(e) {
					...
					return (
						...
						(r.handlePush = function(e) {
							var t = r.props,
								...
								o = t.context;
							(o.action = "PUSH"),
								(o.location = z(n, Object(c.createLocation)(e))),
								(o.url = H(o.location));
						}),
						(r.handleReplace = function(e) {
							var t = r.props,
				...
				return (
					...
					(t.prototype.render = function() {
						...
						return a.a.createElement(y, L({}, r, { history: o }));
					}),
					t
				);
			})(a.a.Component);
	...
	function(e, t, n) {
		...
		var p = (0, l.createStore)(function(e, t) {
				switch (t.type) {
					case "CHANGE_CURRENT_QUEST_ID":
						return o({}, e, { currentQuestIDinStore: t.payload });
				}
				return e;
			}),
			d = { type: "CHANGE_CURRENT_QUEST_ID", payload: 7 },
			h = (function(e) {
				function t() {
					!(function(e, t) {
						if (!(e instanceof t))
					...
					return (
						(e.state = { name: "Rest", nameTwo: "One", currentQuestID: 0 }),
						(e.changeCurrentQuestID = e.changeCurrentQuestID.bind(e)),
							...
							value: function(e) {
								...
								"next" === t
									? (console.log("Уа!! Попали в кнопку некст!"),
									  this.setState({
											currentQuestID: this.state.currentQuestID + 1
									  }))
									: "prev" === t &&
										...
										a.default.createElement(
											...
											(function(e, t) {
												...
												return a.default.createElement(
													...
													a.default.createElement("h3", null, n.title),
													a.default.createElement(
														"p",
														null,
														"heh ",
											...
											})(s.default, this.state.currentQuestID)
										),
			...
			return r.default.createElement(
				...
				r.default.createElement(
					...
					r.default.createElement(
						"li",
						null,
						r.default.createElement(o.Link, { to: "/" }, "Home")
					),
					r.default.createElement(
						"li",
						null,
						r.default.createElement(o.Link, { to: "/about" }, "About")
					),
					r.default.createElement(
						"li",
						null,
						r.default.createElement(o.Link, { to: "/quests" }, "Quests")
					)
				)
			);
		};
	...
	function(e, t, n) {
		...
		var p = { currentQuestIDinStore: 0, testState: "initial State" },
			d = (0, u.createStore)(function() {
				var e =
		...
		d.dispatch({ type: "CHANGE_CURRENT_QUEST_ID", payload: 2 }),
						...
						value: function() {
							return (
								...
								a.default.createElement(
									"div",
									{
										className: s.default["app-container"],
										"data-some": "helllo"
									},
	...
	function(e, t, n) {
		...
		var U = { injectEventPluginOrder: E, injectEventPluginsByName: k };
		function A(e, t) {
			var n = e.stateNode;
			if (!n) return null;
			var r = C(n);
		...
		function L(e, t) {
			null !== e && (j = S(j, e)),
				(e = j),
				(j = null),
				e && (R(e, t ? M : I), j && p("95"), d.rethrowCaughtError());
		}
		function D(e, t, n, r) {
		...
		function ke(e) {
			(e.eventPool = []), (e.getPooled = xe), (e.release = Ee);
		}
		a(we.prototype, {
		...
		function Be(e) {
			ze ? (He ? He.push(e) : (He = [e])) : (ze = e);
		}
		function qe() {
			return null !== ze || null !== He;
		}
		function Ve() {
			if (ze) {
				var e = ze,
					t = He;
				if (((He = ze = null), We(e), t))
		...
		function Vt(e) {
			"value" === e.propertyName && Ht(Ft) && Xe(zt, (e = Lt(Ft, e, et(e))));
		}
		function Qt(e, t, n) {
			"focus" === e
				? (qt(), (Ft = n), (Dt = t).attachEvent("onpropertychange", Vt))
				: "blur" === e && qt();
		}
		function Yt(e) {
		...
		var Wn =
			...
			Yn = !1;
		function $n(e, t) {
			if (Yn || null == qn || qn !== l()) return null;
			var n = qn;
			return (
				(n =
				...
				Qn && c(Qn, n)
					? null
					: ((Qn = n),
					  ((e = we.getPooled(Bn.select, Vn, e, t)).type = "select"),
					  (e.target = qn),
					  ee(e),
					  e)
			);
		...
		function Hr(e, t, n, r) {
			...
			switch (t) {
				...
				case "details":
					...
					break;
				case "input":
					Rt(e, n), (i = St(e, n)), Rn("invalid", e), Dr(r, "onChange");
					break;
				case "option":
					i = br(e, n);
					break;
				case "select":
					...
					break;
				case "textarea":
					Er(e, n), (i = xr(e, n)), Rn("invalid", e), Dr(r, "onChange");
					break;
				default:
					i = n;
			}
		...
		function qr(e, t, n, r, o) {
			switch (t) {
				...
				case "details":
					...
					break;
				case "input":
					Rt(e, n), Rn("invalid", e), Dr(o, "onChange");
					break;
				case "select":
					wr(e, n), Rn("invalid", e), Dr(o, "onChange");
					break;
				case "textarea":
					Er(e, n), Rn("invalid", e), Dr(o, "onChange");
			}
			for (var i in (Ur(t, n, Lr), (r = null), n))
		...
		function Uo(e, t, n) {
			var r = e.updateQueue;
			null ===
			(r = null === r ? (e.updateQueue = Ro(e.memoizedState)) : Ao(e, r))
				.lastCapturedUpdate
				...
				case 5:
					...
					if (null !== e && null != t.stateNode) {
						...
						if (((e = Xo($o.current)), gi(t)))
							...
							Hr(e, o, n, r), Kr(o, n) && Pi(t), (t.stateNode = e);
						}
		...
		function Wi(e, t, n, r, o, i) {
			...
			do {
				switch (e.tag) {
					case 3:
						return (e.effectTag |= 1024), void Uo(e, (r = zi(e, r, i)), i);
					case 2:
						if (
							((t = r),
							(n = e.stateNode),
		...
		function aa(e) {
			for (;;) {
				...
				if (0 == (512 & e.effectTag)) {
					...
					if (null !== (e = Bi(e))) return (e.effectTag &= 511), e;
					if (
						(null !== n &&
				...
				switch (t.tag) {
					...
					case 4:
						return (
							...
							lo.current || t.memoizedProps !== o
								? (null === e ? (t.child = si(t, null, o, n)) : xi(e, t, o),
								  (t.memoizedProps = o),
								  (e = t.child))
								: (e = Ti(e, t)),
							e
					...
					case 13:
						return (function(e, t, n) {
							...
							return (t.stateNode = u), Vo(t), xi(e, t, o.children), t.child;
						})(e, t, n);
					case 12:
						e: if (
							((r = t.type),
				...
				for (Ki && !na && p("263"), n = e.return; null !== n; ) {
					switch (n.tag) {
						case 2:
							...
							break;
						case 3:
							Io(n, (e = zi(n, (e = Ho(t, e)), 1)), 1), fa(n, 1), (n = void 0);
							break e;
					}
					n = n.return;
				}
				3 === e.tag && (Io(e, (n = zi(e, (n = Ho(t, e)), 1)), 1), fa(e, 1)),
					(n = void 0);
			}
			return n;
		}
		...
		function fa(e, t) {
			for (; null !== e; ) {
				if (
					...
					(Ki && !na && Xi === n) || Ia(n, r), ja > Ra && p("185");
				}
				e = e.return;
			}
		}
		function pa() {
			return (Qi = Xr() - qi), (Vi = 2 + ((Qi / 10) | 0));
		}
		...
		function Ma(e) {
			...
			var t = Xr() - qi;
			(ma = e), (va = Jr(Aa, { timeout: 10 * (e - 2) - t }));
		}
		function Ia(e, t) {
		...
		function Fa() {
			...
			if (ka) throw ((e = _a), (_a = null), (ka = !1), e);
		}
		function za(e, t, n) {
			ba && p("245"),
				(ba = !0),
				n
					? null !== (n = e.finishedWork)
						? Ha(e, n, t)
						: null !== (n = la(e, t, !0)) &&
						  (Wa() ? (e.finishedWork = n) : Ha(e, n, t))
					: null !== (n = e.finishedWork)
						? Ha(e, n, t)
						: null !== (n = la(e, t, !1)) && Ha(e, n, t),
				(ba = !1);
		}
		function Ha(e, t, n) {
			var r = e.firstBatch;
							...
							switch ((c = ta).tag) {
								case 2:
									if (256 & c.effectTag && null !== x) {
										...
										var C = _.getSnapshotBeforeUpdate(E, k);
			...
			for (ta = o; null !== ta; ) {
				...
				try {
					for (; null !== ta; ) {
						...
						switch (14 & O) {
							case 2:
								Li(ta), (ta.effectTag &= -3);
								break;
							case 6:
								Li(ta), (ta.effectTag &= -3), Fi(ta.alternate, ta);
								break;
							case 4:
								Fi(ta.alternate, ta);
								break;
			...
			if (
				...
				(O = P.focusedElem),
				(x = P.selectionRange),
				T !== O && s(document.documentElement, O))
			) {
				null !== x &&
					Hn(O) &&
					((T = x.start),
					...
					"selectionStart" in O
						...
						: window.getSelection &&
						  ...
						  (E = O[he()].length),
						  (P = Math.min(x.start, E)),
						  (x = void 0 === x.end ? P : Math.min(x.end, E)),
						  !T.extend && P > x && ((E = x), (x = P), (P = E)),
						  (E = zn(O, P)),
						  (k = zn(O, x)),
						  E &&
								k &&
								...
								((_ = document.createRange()).setStart(E.node, E.offset),
								T.removeAllRanges(),
								P > x
				...
				for (
					...
					((P = T[O]).element.scrollLeft = P.left),
		...
		Fe.injectFiberControlledHostComponent(Qr),
			...
			(Ja.prototype.commit = function() {
				...
				if (((this._defer && null !== t) || p("251"), this._hasChildren)) {
					...
					(this._defer = !1),
						(function(e, t) {
							ba && p("253"), (ga = e), (wa = t), za(e, t, !1), La(), Fa();
						})(e, n),
						(t = this._next),
						(this._next = null),
		...
		var D = {
				Children: {
					...
					forEach: function(e, t, n) {
						if (null == e) return e;
						(t = j(null, null, t, n)), null == e || M(e, "", U, t), N(t);
					},
					count: function(e) {
